...
- [x] Fix `/builder` image/proxy **or** serve explicit unavailable page (stub on `:3001`, 200 HTML — **real builder tree not on VPS; stub accepted**; CE builder logic lives in `client-engine/src/lib/builder`)
