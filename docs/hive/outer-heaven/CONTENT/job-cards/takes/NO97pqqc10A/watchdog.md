...
**Walk:** 2026-08-14 re-walk · Nate 82 shortlist · short · 0:33 · 99 words

## A. Source Map

Speaker/channel: **Nate Herk | AI Automation**. Title: *Agentic Arena: AI Trivia Bot & Robot Smackdowns!*. Kind: short. Duration: 0:33. Caption words: 99. Corpus tag: Nate 82 shortlist.
...
1. And Nate is using his co-pilot power up to get chat chief t to generate a system prompt for his AI agent. >> We using five. >> It's it's pretty smart.
2. I like it.
3. Although in it end sometimes it has some issues. >> Let's also give it up for our robot friend here. >> Because this this poor little sucker is going to be getting hit to the ground if our players don't have an absolute perfect score.
4. And we may have even designed one question that is going to be very hard for them to get right.

## B. Atomic Knowledge

### Opening claim
- **Claim:** And Nate is using his co-pilot power up to get chat chief t to generate a system prompt for his AI agent.
...
- **Evidence:** SOURCE quote: “And Nate is using his co-pilot power up to get chat chief t to generate a system prompt for his AI agent.”
...
- **Source:** `NO97pqqc10A` @ 0:00
- **Epistemic:** SOURCE
### Warning / hedge
- **Claim:** >> Because this this poor little sucker is going to be getting hit to the ground if our players don't have an absolute perfect score.
- **Reasoning:** Speaker named a limit, hedge, or thing the agent should not do.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “>> Because this this poor little sucker is going to be getting hit to the ground if our players don't have an absolute perfect score.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Keep the hedge as the desk. It is usually the steal.
- **Confidence:** high as SOURCE hedge; still not a ship
- **Source:** `NO97pqqc10A` @ 0:10
- **Epistemic:** SOURCE
### Close / CTA
- **Claim:** And we may have even designed one question that is going to be very hard for them to get right.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “And we may have even designed one question that is going to be very hard for them to get right.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Store the claim. Do not operate the payload. Challenge in H.
- **Confidence:** medium as SOURCE-of-speech; low as business fact
- **Source:** `NO97pqqc10A` @ 0:21
- **Epistemic:** SOURCE
### Tape claim
- **Claim:** Although in it end sometimes it has some issues.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “Although in it end sometimes it has some issues.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Store the claim. Do not operate the payload. Challenge in H.
- **Confidence:** medium as SOURCE-of-speech; low as business fact
- **Source:** `NO97pqqc10A` @ 0:07
- **Epistemic:** SOURCE
### Tape claim
- **Claim:** >> Let's also give it up for our robot friend here.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “>> Let's also give it up for our robot friend here.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Store the claim. Do not operate the payload. Challenge in H.
- **Confidence:** medium as SOURCE-of-speech; low as business fact
- **Source:** `NO97pqqc10A` @ 0:08
- **Epistemic:** SOURCE
...
- >> Because this this poor little sucker is going to be getting hit to the ground if our players don't have an absolute perfect score. — `NO97pqqc10A` @ 0:10
...
- **Situation:** And Nate is using his co-pilot power up to get chat chief t to generate a system prompt for his AI agent. >> We using five. >> It's it's pretty smart.
- **Action:** I like it.
- **Reasoning:** Speaker treats the on-screen path as sufficient teaching.
- **Outcome:** Although in it end sometimes it has some issues. >> Let's also give it up for our robot friend here. >> Because this this poor little sucker is going to be getting hit to the ground if our players don't have an absolute perfect score.
- **Lesson:** >> Because this this poor little sucker is going to be getting hit to the ground if our players don't have an absolute perfect score.
- **Implicit rule:** If the demo cannot be re-opened as a file/URL/log, it is theater.
- **Source:** `NO97pqqc10A` @ 0:00 · Epistemic: SOURCE (walkthrough) + INFERENCE (lesson)

## F. Decision Rules

- Speaker hedge to keep: >> Because this this poor little sucker is going to be getting hit to the ground if our players don't have an absolute perfect score.
...
- Fragment. I steal **perfect-score fixture**, not the robot.
- **FLAG: copilot prompt as a ship.** ChatGPT-written prompt still needs `golden-test-loop`. Hard question is the cake-fork. Clients parked.
