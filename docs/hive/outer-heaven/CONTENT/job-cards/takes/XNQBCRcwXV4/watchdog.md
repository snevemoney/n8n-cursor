...
**Walk:** 2026-08-14 re-walk · other Nate packet · video · 11:56 · 2902 words

## A. Source Map

Speaker/channel: **Nate Herk | AI Automation**. Title: *I Deleted All My Claude Skills... And Claude Got Smarter*. Kind: video. Duration: 11:56. Caption words: 2902. Corpus tag: other Nate packet.
...
1. So, I listened to the creator of Claude Code explain why Claude has gotten worse and how to actually fix that.
2. Now, Opus 5 just does it. >> So, that's interesting.
3. Here's what the title should look like.
4. Because what my gut's telling me is a lot of this advice that Boris is going to tell you, or that you might see Andrej Karpathy tweet about, a lot of their advice is coming from the perspective of someone who's like in the weeds designing harnesses, working on massive code bas…
5. And there are so many capabilities the model has like this that people are not aware of.
6. You verify yourself so that I don't have to verify.
7. They have taste.
8. And I'll see you on the next one.
Close: And as always, I appreciate you guys making it to the end of the video. (`XNQBCRcwXV4` @ 11:49)

## B. Atomic Knowledge

### Opening claim
- **Claim:** So, I listened to the creator of Claude Code explain why Claude has gotten worse and how to actually fix that.
...
- **Evidence:** SOURCE quote: “So, I listened to the creator of Claude Code explain why Claude has gotten worse and how to actually fix that.”
...
- **Source:** `XNQBCRcwXV4` @ 0:01
- **Epistemic:** SOURCE
### Named method
- **Claim:** I'm looking for you to give me something that has been tested and iterated on 10 times and has been fully QA'd and that's ready to go to market tomorrow." That makes it a little bit more emotional.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “I'm looking for you to give me something that has been tested and iterated on 10 times and has been fully QA'd and that's ready to go to market tomorrow." That makes it a little bit more emotional.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
...
- **Source:** `XNQBCRcwXV4` @ 3:02
- **Epistemic:** SOURCE
### Demo / proof move
- **Claim:** But as you saw from this demo, like I still need the skills to say, "Hey, you're going to grab this image.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “But as you saw from this demo, like I still need the skills to say, "Hey, you're going to grab this image.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Store the claim. Do not operate the payload. Challenge in H.
- **Confidence:** medium as SOURCE-of-speech; low as business fact
- **Source:** `XNQBCRcwXV4` @ 7:00
- **Epistemic:** SOURCE
### Pricing or scale claim
- **Claim:** You actually deleted over 80% of the system prompt from Claude Code.
- **Reasoning:** Speaker used a number to prove value or close a CTA.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “You actually deleted over 80% of the system prompt from Claude Code.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Label UNVERIFIED. Steal the *structure* (didn’t-send, napkin, package), not the number.
- **Confidence:** low as FACT
- **Source:** `XNQBCRcwXV4` @ 0:26
- **Epistemic:** SOURCE
### Warning / hedge
- **Claim:** It's super easy to do and you don't need any technical experience to actually implement this stuff.
- **Reasoning:** Speaker named a limit, hedge, or thing the agent should not do.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “It's super easy to do and you don't need any technical experience to actually implement this stuff.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Keep the hedge as the desk. It is usually the steal.
- **Confidence:** high as SOURCE hedge; still not a ship
- **Source:** `XNQBCRcwXV4` @ 0:13
- **Epistemic:** SOURCE
### Close / CTA
...
- It's super easy to do and you don't need any technical experience to actually implement this stuff. — `XNQBCRcwXV4` @ 0:13
- >> I think something that a lot of people might not realize is um Claude Code as a product and as a harness is just always changing. — `XNQBCRcwXV4` @ 0:35
- Make sure they all still feel good." And for some reason with Opus 5, it's just felt degraded to the point where I'm actually going back to 4.8 every once in a while when I need to do something and I'm just getting better results. — `XNQBCRcwXV4` @ 1:41
- But, I never really thought about, "Hmm, maybe if I just got rid of some of my instructions and got out of the model's way, it is actually just more intelligent now and it could handle those things." So, take a look at this next clip. — `XNQBCRcwXV4` @ 1:51
- >> So, when you think about that for a sec, I feel like that almost sounds counterintuitive because what we've been told is, "Hey, you know, if everyone has access to the same model," or something this is something I say a lot, "then wouldn't everybody be getting the same resu… — `XNQBCRcwXV4` @ 2:26
...
- **Situation:** So, I listened to the creator of Claude Code explain why Claude has gotten worse and how to actually fix that.
- **Action:** Now, Opus 5 just does it. >> So, that's interesting.
- **Reasoning:** Speaker treats the on-screen path as sufficient teaching.
- **Outcome:** Here's what the title should look like.
- **Lesson:** It's super easy to do and you don't need any technical experience to actually implement this stuff.
- **Implicit rule:** If the demo cannot be re-opened as a file/URL/log, it is theater.
- **Source:** `XNQBCRcwXV4` @ 0:01 · Epistemic: SOURCE (walkthrough) + INFERENCE (lesson)

## F. Decision Rules

- Speaker hedge to keep: It's super easy to do and you don't need any technical experience to actually implement this stuff.
...
- **Tape $ / counts UNVERIFIED:** 80%, 3 months, 6 months. Speaker said or implied them; I do not promote them to FACT, price analog, or Path A MUST.
