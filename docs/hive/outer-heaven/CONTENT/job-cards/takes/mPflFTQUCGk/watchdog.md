...
**Walk:** 2026-08-14 re-walk · Nate 82 shortlist · short · 1:55 · 515 words

## A. Source Map

Speaker/channel: **Nate Herk | AI Automation**. Title: *Unlock the Full Power of Your AI Agents with n8n Instance MCP*. Kind: short. Duration: 1:55. Caption words: 515. Corpus tag: Nate 82 shortlist.
...
1. Here's how to use NINDN's new instance level MCP.
2. Well, now instead of just writing it and then copy and pasting it, you can go ahead and just say we'll send that off now.
3. Claude was able to just find it and do it.
4. If you want to watch the full breakdown, then click on that play button right here.

## B. Atomic Knowledge

### Opening claim
- **Claim:** Here's how to use NINDN's new instance level MCP.
...
- **Evidence:** SOURCE quote: “Here's how to use NINDN's new instance level MCP.”
...
- **Source:** `mPflFTQUCGk` @ 0:01
- **Epistemic:** SOURCE
### Demo / proof move
- **Claim:** All right, I'm going to start off with claude.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “All right, I'm going to start off with claude.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Store the claim. Do not operate the payload. Challenge in H.
- **Confidence:** medium as SOURCE-of-speech; low as business fact
- **Source:** `mPflFTQUCGk` @ 0:07
- **Epistemic:** SOURCE
### Close / CTA
...
- **Action:** Store the claim. Do not operate the payload. Challenge in H.
- **Confidence:** medium as SOURCE-of-speech; low as business fact
- **Source:** `mPflFTQUCGk` @ 1:47
- **Epistemic:** SOURCE
### Tape claim
- **Claim:** What I'm going to do is I'm going to click on this little icon right here and I'm going to go to add connectors.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “What I'm going to do is I'm going to click on this little icon right here and I'm going to go to add connectors.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Store the claim. Do not operate the payload. Challenge in H.
- **Confidence:** medium as SOURCE-of-speech; low as business fact
- **Source:** `mPflFTQUCGk` @ 0:09
- **Epistemic:** SOURCE
### Tape claim
- **Claim:** Well, now instead of just writing it and then copy and pasting it, you can go ahead and just say we'll send that off now.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “Well, now instead of just writing it and then copy and pasting it, you can go ahead and just say we'll send that off now.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Store the claim. Do not operate the payload. Challenge in H.
- **Confidence:** medium as SOURCE-of-speech; low as business fact
- **Source:** `mPflFTQUCGk` @ 0:31
- **Epistemic:** SOURCE
...
- Just make sure you actually enable this and you toggle that on. — `mPflFTQUCGk` @ 0:03
- Now if it's your first time doing this you will have to basically just copy in your server URL and give it to Claude. — `mPflFTQUCGk` @ 0:21
- Well, now instead of just writing it and then copy and pasting it, you can go ahead and just say we'll send that off now. — `mPflFTQUCGk` @ 0:31
- So I'm going to always allow this tool as well. — `mPflFTQUCGk` @ 0:54
- So, I'm going to go ahead and always allow. — `mPflFTQUCGk` @ 1:00
...
- **Situation:** Here's how to use NINDN's new instance level MCP.
- **Action:** Well, now instead of just writing it and then copy and pasting it, you can go ahead and just say we'll send that off now.
- **Reasoning:** Speaker treats the on-screen path as sufficient teaching.
- **Outcome:** Claude was able to just find it and do it.
- **Lesson:** Just make sure you actually enable this and you toggle that on.
- **Implicit rule:** If the demo cannot be re-opened as a file/URL/log, it is theater.
- **Source:** `mPflFTQUCGk` @ 0:01 · Epistemic: SOURCE (walkthrough) + INFERENCE (lesson)

## F. Decision Rules

- Speaker hedge to keep: Just make sure you actually enable this and you toggle that on.
...
- Does the pair tape (9IzGe0BBj_c, 5p5cV0yVDvQ) contradict a hedge on this cut?
...
- Paired / overlapping titles on disk: `9IzGe0BBj_c`, `5p5cV0yVDvQ`. Walk both; do not ship from the short.
...
- This is a send-from-chat teaser. I steal **open the inbox**, not always-allow send.
- **FLAG: always-allow on a Send tool.** If it has Send, assume it will send. Always-allow is the leak. `ask-principal` every send. Doctrine: first Gmail = read+draft (`send-removed`).
- **He did open the inbox.** That is `click-live-site`. Keep the open; drop the always-allow.
- **Dundermifflin is a demo.** Not a ship. Clients parked.
