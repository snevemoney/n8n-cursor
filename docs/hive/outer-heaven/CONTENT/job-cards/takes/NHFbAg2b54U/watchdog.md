...
**Walk:** 2026-08-14 re-walk · other Nate packet · video · 17:22 · 3858 words

## A. Source Map

Speaker/channel: **Nate Herk | AI Automation**. Title: *100 Years of Artificial Intelligence Explained*. Kind: video. Duration: 17:22. Caption words: 3858. Corpus tag: other Nate packet.
Captions are yt-dlp ingest. Visual-only beats (UI clicks, audio beds, overlays) are **gaps** — timestamp 0:02 on the open, else UNKNOWN.
Beats in order (do not skip asides):
1. September 2012, in a bedroom in his parents' house, 26-year-old Alex Krizhevsky is creating a system inside two gaming graphics cards.
2. And there's actually a great movie about this with Benedict Cumberbatch called The Imitation Game.
3. This perception was called the symbolic approach, but the Rosenblatt perception was the complete opposite.
4. In 1980, the first big commercial AI system was revealed at Carnegie Mellon University.
5. Rosenblatt didn't have time to fix his approach, but Hinton and others continued his work.
6. When the competition ended, AlexNet got 15% of the answers wrong, 11 points less than last year's winner.
7. So, they fed it massive data sets from the web, books, and code, and they had it make predictions billions of times.
8. The history of AI is far from being over, and I'm super excited.

## B. Atomic Knowledge

### Opening claim
- **Claim:** September 2012, in a bedroom in his parents' house, 26-year-old Alex Krizhevsky is creating a system inside two gaming graphics cards.
...
- **Evidence:** SOURCE quote: “September 2012, in a bedroom in his parents' house, 26-year-old Alex Krizhevsky is creating a system inside two gaming graphics cards.”
...
- **Source:** `NHFbAg2b54U` @ 0:02
- **Epistemic:** SOURCE
### Named method
- **Claim:** These neural systems could write code, summarize documents, draft emails, answer questions from a single prompt.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “These neural systems could write code, summarize documents, draft emails, answer questions from a single prompt.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
...
- **Source:** `NHFbAg2b54U` @ 14:39
- **Epistemic:** SOURCE
### Pricing or scale claim
- **Claim:** There was no reason to spend $70,000 on a Lisp machine when a $10,000 Sun workstation could run the same program.
- **Reasoning:** Speaker used a number to prove value or close a CTA.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “There was no reason to spend $70,000 on a Lisp machine when a $10,000 Sun workstation could run the same program.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Label UNVERIFIED. Steal the *structure* (didn’t-send, napkin, package), not the number.
- **Confidence:** low as FACT
- **Source:** `NHFbAg2b54U` @ 8:21
- **Epistemic:** SOURCE
### Warning / hedge
- **Claim:** But in this video, I'm just going to be saying Bombe, so don't get mad at me.
- **Reasoning:** Speaker named a limit, hedge, or thing the agent should not do.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “But in this video, I'm just going to be saying Bombe, so don't get mad at me.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Keep the hedge as the desk. It is usually the steal.
- **Confidence:** high as SOURCE hedge; still not a ship
- **Source:** `NHFbAg2b54U` @ 1:02
- **Epistemic:** SOURCE
### Close / CTA
- **Claim:** The history of AI is far from being over, and I'm super excited.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “The history of AI is far from being over, and I'm super excited.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Store the claim. Do not operate the payload. Challenge in H.
- **Confidence:** medium as SOURCE-of-speech; low as business fact
- **Source:** `NHFbAg2b54U` @ 17:15
- **Epistemic:** SOURCE
...
- But in this video, I'm just going to be saying Bombe, so don't get mad at me. — `NHFbAg2b54U` @ 1:02
- Anyways, that statement created the first waves of people reframing what an intelligent machine actually was. — `NHFbAg2b54U` @ 2:17
- If you see this other thing, do this other thing. — `NHFbAg2b54U` @ 3:59
- Then the sequences continue until the machine can handle every single possible situation. — `NHFbAg2b54U` @ 4:00
- So, if you write enough logic, you'll get intelligence. — `NHFbAg2b54U` @ 4:07
...
- **Situation:** September 2012, in a bedroom in his parents' house, 26-year-old Alex Krizhevsky is creating a system inside two gaming graphics cards.
- **Action:** And there's actually a great movie about this with Benedict Cumberbatch called The Imitation Game.
- **Reasoning:** Speaker treats the on-screen path as sufficient teaching.
- **Outcome:** This perception was called the symbolic approach, but the Rosenblatt perception was the complete opposite.
- **Lesson:** But in this video, I'm just going to be saying Bombe, so don't get mad at me.
- **Implicit rule:** If the demo cannot be re-opened as a file/URL/log, it is theater.
- **Source:** `NHFbAg2b54U` @ 0:02 · Epistemic: SOURCE (walkthrough) + INFERENCE (lesson)

## F. Decision Rules

- Speaker hedge to keep: But in this video, I'm just going to be saying Bombe, so don't get mad at me.
...
- **Tape $ / counts UNVERIFIED:** $70,000, $10,000, 3 million, 14 million, 1.2 million, 28%, 26%, 15%. Speaker said or implied them; I do not promote them to FACT, price analog, or Path A MUST.
...
### Machine: executed check vs last-known-good
...
- **Procedure:** Open the artifact. A talk-track is not a smoke. Run D. Fail-closed before send/pay/deploy/book/publish.
...
- **Operate-never payload:** generic payload may be non-empty (vendor / dial / post / jackpot / School). Machine still stolen.
...
- **Challenge job (§8):** I keep the disagreements in H. I still steal **executed check vs last-known-good**.
