...
**Walk:** 2026-08-14 re-walk · Nate 82 shortlist · short · 2:14 · 484 words

## A. Source Map

Speaker/channel: **Nate Herk | AI Automation**. Title: *I Built an AI Voice Receptionist with Vapi and n8n MCP*. Kind: short. Duration: 2:14. Caption words: 484. Corpus tag: Nate 82 shortlist.
...
1. This NADN MCP server powers my entire voice agent.
2. But that's what's so cool about this is that each tool has one very specific function.
3. And then my phone number is 3334445678. >> Just to confirm, your email is nateample.com.
4. If you want to watch the full breakdown, then click on that play button right here, and I'll see you guys over

## B. Atomic Knowledge

### Opening claim
- **Claim:** This NADN MCP server powers my entire voice agent.
...
- **Evidence:** SOURCE quote: “This NADN MCP server powers my entire voice agent.”
...
- **Source:** `glM8godEcic` @ 0:00
- **Epistemic:** SOURCE
### Named method
- **Claim:** >> Just to confirm, your email is nateample.com.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “>> Just to confirm, your email is nateample.com.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Store the claim. Do not operate the payload. Challenge in H.
- **Confidence:** medium as SOURCE-of-speech; low as business fact
- **Source:** `glM8godEcic` @ 1:14
- **Epistemic:** SOURCE
### Demo / proof move
- **Claim:** I'm going to pull up the calendar on the lefth hand side and the CRM on the right hand side so that we can see all of this updating and happening in real time.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “I'm going to pull up the calendar on the lefth hand side and the CRM on the right hand side so that we can see all of this updating and happening in real time.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Store the claim. Do not operate the payload. Challenge in H.
- **Confidence:** medium as SOURCE-of-speech; low as business fact
- **Source:** `glM8godEcic` @ 0:38
- **Epistemic:** SOURCE
### Close / CTA
...
- **Action:** Store the claim. Do not operate the payload. Challenge in H.
- **Confidence:** medium as SOURCE-of-speech; low as business fact
- **Source:** `glM8godEcic` @ 2:06
- **Epistemic:** SOURCE
### Tape claim
- **Claim:** It is our MCP server with all seven of these workflows that we also built out in Naden.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “It is our MCP server with all seven of these workflows that we also built out in Naden.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Store the claim. Do not operate the payload. Challenge in H.
- **Confidence:** medium as SOURCE-of-speech; low as business fact
- **Source:** `glM8godEcic` @ 0:10
- **Epistemic:** SOURCE
...
- And then here is our delete appointment. — `glM8godEcic` @ 0:26
- And so it's just basically up to Vappy and the MCP server to figure out which one to call and then it can get answers back so quick. — `glM8godEcic` @ 0:31
- If you need to change anything or have any questions about your appointment or our services, seriously, just let me know. — `glM8godEcic` @ 1:59
- If you want to watch the full breakdown, then click on that play button right here, and I'll see you guys over — `glM8godEcic` @ 2:06
...
- **Situation:** This NADN MCP server powers my entire voice agent.
- **Action:** But that's what's so cool about this is that each tool has one very specific function.
- **Reasoning:** Speaker treats the on-screen path as sufficient teaching.
- **Outcome:** And then my phone number is 3334445678. >> Just to confirm, your email is nateample.com.
...
- **Source:** `glM8godEcic` @ 0:00 · Epistemic: SOURCE (walkthrough) + INFERENCE (lesson)
...
- Does the pair tape (y-cq_Qo4zVo) contradict a hedge on this cut?
...
- Paired / overlapping titles on disk: `y-cq_Qo4zVo`. Walk both; do not ship from the short.
...
- Teaser. I steal **one-tool-one-job**, not the reserved spot.
- **FLAG: reserved = booked without a fixture.** Short skips the move-appointment and outbound tease. Auto-book remains operate-never.
