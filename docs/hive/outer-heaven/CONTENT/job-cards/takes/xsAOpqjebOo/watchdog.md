# Watchdog — xsAOpqjebOo
Status: filled
Protocol: deep-video-learning
**Source:** `docs/hive/outer-heaven/CONTENT/watch-later/packets/xsAOpqjebOo/full.txt`
**Packet LEARNED:** `docs/hive/outer-heaven/CONTENT/watch-later/packets/xsAOpqjebOo/LEARNED.md`
**ICP:** parked unless Evens named one.
**Lens:** challenge claims (protocol §8) · steal the machine · operate ≠ learn
**Walk:** 2026-08-14 re-walk · Nate 82 shortlist · short · 1:47 · 452 words

## A. Source Map

Speaker/channel: **Nate Herk | AI Automation**. Title: *I Can Actually Watch My AI Agents Work Now*. Kind: short. Duration: 1:47. Caption words: 452. Corpus tag: Nate 82 shortlist.
...
1. You see these little agents working right up here?
2. What you can also see on this right-hand side, that's exactly what's being ran right now.
3. So I can see that those sub-agents on this left-hand side are disappearing, so I can hop back over to that first terminal, and I'll be able to see that this first one is already done, and now the OpenAI one is still being worked on, which is this agent right over here.
4. If you want to watch the full breakdown, then click on that play button right here, and I'll see you guys over there.

## B. Atomic Knowledge

### Opening claim
- **Claim:** You see these little agents working right up here?
...
- **Evidence:** SOURCE quote: “You see these little agents working right up here?”
...
- **Source:** `xsAOpqjebOo` @ 0:00
- **Epistemic:** SOURCE
### Demo / proof move
- **Claim:** And now you can see that we have three agents actually running right now in parallel.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “And now you can see that we have three agents actually running right now in parallel.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
...
- **Source:** `xsAOpqjebOo` @ 0:18
- **Epistemic:** SOURCE
### Pricing or scale claim
- **Claim:** And then coming over to the second terminal, we can see the comment analysis over the last 2 weeks.
- **Reasoning:** Speaker used a number to prove value or close a CTA.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “And then coming over to the second terminal, we can see the comment analysis over the last 2 weeks.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Label UNVERIFIED. Steal the *structure* (didn’t-send, napkin, package), not the number.
- **Confidence:** low as FACT
- **Source:** `xsAOpqjebOo` @ 1:30
- **Epistemic:** SOURCE
### Warning / hedge
- **Claim:** I don't know where she's off to, but you can see now that both of these agents are done.
- **Reasoning:** Speaker named a limit, hedge, or thing the agent should not do.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “I don't know where she's off to, but you can see now that both of these agents are done.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Keep the hedge as the desk. It is usually the steal.
- **Confidence:** high as SOURCE hedge; still not a ship
- **Source:** `xsAOpqjebOo` @ 1:21
- **Epistemic:** SOURCE
### Close / CTA
- **Claim:** If you want to watch the full breakdown, then click on that play button right here, and I'll see you guys over there.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “If you want to watch the full breakdown, then click on that play button right here, and I'll see you guys over there.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Store the claim. Do not operate the payload. Challenge in H.
- **Confidence:** medium as SOURCE-of-speech; low as business fact
- **Source:** `xsAOpqjebOo` @ 1:39
- **Epistemic:** SOURCE
...
- So when I send off this message where I'm asking it to spin up two researcher agents, one to research Google, one to research OpenAI, and then create a visual diagram, you'll see that this agent actually gets that task. — `xsAOpqjebOo` @ 0:07
- So I can see that those sub-agents on this left-hand side are disappearing, so I can hop back over to that first terminal, and I'll be able to see that this first one is already done, and now the OpenAI one is still being worked on, which is this agent right over here. — `xsAOpqjebOo` @ 0:04
- I don't know where she's off to, but you can see now that both of these agents are done. — `xsAOpqjebOo` @ 1:21
- And then coming over to the second terminal, we can see the comment analysis over the last 2 weeks. — `xsAOpqjebOo` @ 1:30
- So we've got some pain points about Claude API costs and it into Claude Code, getting first client with zero social proof. — `xsAOpqjebOo` @ 1:33
...
- **Situation:** You see these little agents working right up here?
- **Action:** What you can also see on this right-hand side, that's exactly what's being ran right now.
- **Reasoning:** Speaker treats the on-screen path as sufficient teaching.
- **Outcome:** So I can see that those sub-agents on this left-hand side are disappearing, so I can hop back over to that first terminal, and I'll be able to see that this first one is already done, and now the OpenAI one is still being worked on, which is this agent right over here.
- **Lesson:** I don't know where she's off to, but you can see now that both of these agents are done.
- **Implicit rule:** If the demo cannot be re-opened as a file/URL/log, it is theater.
- **Source:** `xsAOpqjebOo` @ 0:00 · Epistemic: SOURCE (walkthrough) + INFERENCE (lesson)

## F. Decision Rules

- Speaker hedge to keep: I don't know where she's off to, but you can see now that both of these agents are done.
...
- **Tape $ / counts UNVERIFIED:** 2 weeks. Speaker said or implied them; I do not promote them to FACT, price analog, or Path A MUST.
...
- Does the pair tape (62Rfe1w9NBc) contradict a hedge on this cut?
...
- Paired / overlapping titles on disk: `62Rfe1w9NBc`. Walk both; do not ship from the short.
...
- This is a watch-the-agents teaser. I steal **headed observe + approval**, not the pixel office.
- **FLAG: idle = done is a self-score.** A disappearing sprite is not `click-live-site`. I open the diagram / the comment report. “Looks pretty” is the long tape’s hedge — this short skips it.
- **Needs approval is the desk.** That is `ask-principal`. I do not skip the prompt because the pixel looks busy.
- **Zero social proof / API cost on the comment report — UNVERIFIED.** Not our metric. Clients parked.
...
- **I would not call done** from a dashboard reload, a `short` flex, or tape $.
