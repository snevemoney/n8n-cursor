...
**Walk:** 2026-08-14 re-walk · other Nate packet · video · 20:14 · 5103 words

## A. Source Map

Speaker/channel: **Nate Herk | AI Automation**. Title: *I Tested Every Claude Code Feature, These 12 Are the Best*. Kind: video. Duration: 20:14. Caption words: 5103. Corpus tag: other Nate packet.
...
1. So I've spent well over 500 hours inside of Claude's ecosystem, chat, co-work, Claude code.
2. So once again, just like a very basic feature, but it is still useful.
3. It definitely uses a lot of tokens but it processes things in parallel really really well.
4. Auto mode, I like using auto mode as a permission level in my Cloud code.
5. This would be a month, but I got a new PC here, so it only was able to look through, um, you know, the past two to three weeks-ish of local data.
6. So, you can create these markdown files of agents that get invoked the same way a skill does pretty much, and you're customizing what that agent does and what tools it may use and any skills that live inside of an agent.
7. I can then see 27% 274,000 tokens out of a million tokens.
8. Thanks, guys.
Close: And as always, I appreciate making it to the end of the video, and I will see you all in the next one. (`vfWTyEreOEc` @ 20:06)

## B. Atomic Knowledge

### Opening claim
- **Claim:** So I've spent well over 500 hours inside of Claude's ecosystem, chat, co-work, Claude code.
...
- **Evidence:** SOURCE quote: “So I've spent well over 500 hours inside of Claude's ecosystem, chat, co-work, Claude code.”
...
- **Source:** `vfWTyEreOEc` @ 0:00
- **Epistemic:** SOURCE
### Demo / proof move
- **Claim:** You can see here I just tried out themes.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “You can see here I just tried out themes.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
...
- **Source:** `vfWTyEreOEc` @ 1:46
- **Epistemic:** SOURCE
### Warning / hedge
- **Claim:** It's super important to set up, and if you don't have that in your project, it's not going to feel very good.
- **Reasoning:** Speaker named a limit, hedge, or thing the agent should not do.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “It's super important to set up, and if you don't have that in your project, it's not going to feel very good.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Keep the hedge as the desk. It is usually the steal.
- **Confidence:** high as SOURCE hedge; still not a ship
- **Source:** `vfWTyEreOEc` @ 1:11
- **Epistemic:** SOURCE
### Close / CTA
- **Claim:** And as always, I appreciate making it to the end of the video, and I will see you all in the next one.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “And as always, I appreciate making it to the end of the video, and I will see you all in the next one.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Store the claim. Do not operate the payload. Challenge in H.
- **Confidence:** medium as SOURCE-of-speech; low as business fact
- **Source:** `vfWTyEreOEc` @ 20:06
- **Epistemic:** SOURCE
### Tape claim
- **Claim:** And don't get me wrong, I think co-work is an amazing product but for me, I just went straight to Claude Code and I feel like pretty much anything you can do in co-work, you can do in code.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “And don't get me wrong, I think co-work is an amazing product but for me, I just went straight to Claude Code and I feel like pretty much anything you can do in co-work, you can do in code.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Store the claim. Do not operate the payload. Challenge in H.
- **Confidence:** medium as SOURCE-of-speech; low as business fact
- **Source:** `vfWTyEreOEc` @ 2:34
- **Epistemic:** SOURCE
...
- So if you are, you might disagree with some of these. — `vfWTyEreOEc` @ 0:34
- You guys can screenshot this or pause this if you want, but I wanted to call out a few that I think are kind of the standouts of this tier. — `vfWTyEreOEc` @ 0:59
- It's super important to set up, and if you don't have that in your project, it's not going to feel very good. — `vfWTyEreOEc` @ 1:11
- Web search, you know, Claude code obviously has its native web search, and then you can do your web fetches, which is cool because it will spin off research for you right away. — `vfWTyEreOEc` @ 1:28
- And then we've got some other things in here like file uploads, fast mode, permissions, custom themes is something that you can do. — `vfWTyEreOEc` @ 1:38
...
- **Situation:** So I've spent well over 500 hours inside of Claude's ecosystem, chat, co-work, Claude code.
- **Action:** So once again, just like a very basic feature, but it is still useful.
- **Reasoning:** Speaker treats the on-screen path as sufficient teaching.
- **Outcome:** It definitely uses a lot of tokens but it processes things in parallel really really well.
- **Lesson:** It's super important to set up, and if you don't have that in your project, it's not going to feel very good.
- **Implicit rule:** If the demo cannot be re-opened as a file/URL/log, it is theater.
- **Source:** `vfWTyEreOEc` @ 0:00 · Epistemic: SOURCE (walkthrough) + INFERENCE (lesson)

## F. Decision Rules

- Speaker hedge to keep: It's super important to set up, and if you don't have that in your project, it's not going to feel very good.
...
- **Tape $ / counts UNVERIFIED:** 500 hours, 24 hours, 48 hours, 30 days, 50%, 7 days, 27%. Speaker said or implied them; I do not promote them to FACT, price analog, or Path A MUST.
