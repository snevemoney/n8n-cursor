...
**Walk:** 2026-08-14 re-walk · Nate 82 shortlist · short · 2:59 · 641 words

## A. Source Map

Speaker/channel: **Nate Herk | AI Automation**. Title: *4 Simple RAG Methods for Better AI Agents*. Kind: short. Duration: 2:59. Caption words: 641. Corpus tag: Nate 82 shortlist.
...
1. If your agents aren't giving you accurate answers, watch this video.
2. So that just finished up and it said you sold five Bluetooth speakers on September 16th.
3. But we all know what could happen when you do that.
4. If you want to watch the full breakdown, then click on that play button right here, and I'll see you guys over

## B. Atomic Knowledge

### Opening claim
- **Claim:** If your agents aren't giving you accurate answers, watch this video.
...
- **Evidence:** SOURCE quote: “If your agents aren't giving you accurate answers, watch this video.”
...
- **Source:** `ZwQ8rJhVCr4` @ 0:00
- **Epistemic:** SOURCE
### Named method
- **Claim:** So if I first of all ask it that same question, which was give me a chronological breakdown of the agent in 2 hours video, we're going to notice that it's faster and cheaper, but we're also of course going to notice that it's not as accurate because it doesn't understand order…
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “So if I first of all ask it that same question, which was give me a chronological breakdown of the agent in 2 hours video, we're going to notice that it's faster and cheaper, but we're also of course going to notice that it's not as accurate because it doesn't understand order…”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
...
- **Source:** `ZwQ8rJhVCr4` @ 2:37
- **Epistemic:** SOURCE
### Demo / proof move
- **Claim:** And when we click on the AI agent, we can see that this only took 4,000 tokens out of GBT5 Mini's 400,000 context window limit.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “And when we click on the AI agent, we can see that this only took 4,000 tokens out of GBT5 Mini's 400,000 context window limit.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Store the claim. Do not operate the payload. Challenge in H.
- **Confidence:** medium as SOURCE-of-speech; low as business fact
- **Source:** `ZwQ8rJhVCr4` @ 2:04
- **Epistemic:** SOURCE
### Pricing or scale claim
- **Claim:** So I am asking this agent to give me a chronological breakdown of the agent in 2 hours video.
- **Reasoning:** Speaker used a number to prove value or close a CTA.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “So I am asking this agent to give me a chronological breakdown of the agent in 2 hours video.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Label UNVERIFIED. Steal the *structure* (didn’t-send, napkin, package), not the number.
- **Confidence:** low as FACT
- **Source:** `ZwQ8rJhVCr4` @ 1:49
- **Epistemic:** SOURCE
### Close / CTA
...
- And then we have the final one which is using a vector database. — `ZwQ8rJhVCr4` @ 0:09
- So, the first example that we have is filters. — `ZwQ8rJhVCr4` @ 0:11
- And then what it did was a date query to make sure it's also filtering out any of those rows where the date is not September 16th. — `ZwQ8rJhVCr4` @ 0:33
- So, it said that it ran the top three products by revenue and then it got total revenue by summing it all up. — `ZwQ8rJhVCr4` @ 1:06
- And its results were AI automation course 34.93, which is right here, consulting call 33383 right here, and then workflow template 1659, which is right there. — `ZwQ8rJhVCr4` @ 1:12
...
- **Situation:** If your agents aren't giving you accurate answers, watch this video.
- **Action:** So that just finished up and it said you sold five Bluetooth speakers on September 16th.
- **Reasoning:** Speaker treats the on-screen path as sufficient teaching.
- **Outcome:** But we all know what could happen when you do that.
- **Lesson:** And then what it did was a date query to make sure it's also filtering out any of those rows where the date is not September 16th.
- **Implicit rule:** If the demo cannot be re-opened as a file/URL/log, it is theater.
- **Source:** `ZwQ8rJhVCr4` @ 0:00 · Epistemic: SOURCE (walkthrough) + INFERENCE (lesson)

## F. Decision Rules

- Speaker hedge to keep: And then what it did was a date query to make sure it's also filtering out any of those rows where the date is not September 16th.
...
- **Tape $ / counts UNVERIFIED:** 2 hours. Speaker said or implied them; I do not promote them to FACT, price analog, or Path A MUST.
...
- Does the pair tape (kOKavHnlPik) contradict a hedge on this cut?
...
- Paired / overlapping titles on disk: `kOKavHnlPik`. Walk both; do not ship from the short.
...
- Teaser. I steal **faster ≠ accurate**, not the five-speakers answer.
- **FLAG: first-query as a smoke.** Five speakers / top-three revenue are demo numbers — **UNVERIFIED**. Long tape shows chunk misses. I do not ship from the short.
- **He already said vector is wrong on order.** That is the desk. `golden-test-loop`.
