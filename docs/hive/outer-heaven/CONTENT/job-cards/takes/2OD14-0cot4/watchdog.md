...
**Walk:** 2026-08-14 re-walk · other Nate packet · video · 15:43 · 3855 words

## A. Source Map

Speaker/channel: **Nate Herk | AI Automation**. Title: *GLM 5.2 in Claude Code is Blowing My Mind*. Kind: video. Duration: 15:43. Caption words: 3855. Corpus tag: other Nate packet.
...
1. So, I've been playing around with GLM 5.2 inside of Cloud Code all day and it's incredible.
2. You can see right here we've got GLM and then right here we've got Opus 4.8.
3. First, the sentence is broken.
4. This one was supported by the academic and the skeptic.
5. If you did a heavy day of coding, it'd be about five times cheaper than Opus 4.8 for the same job.
6. You can do 3D modeling.
7. You can also say, "Hey, Claude Code, put this into my settings.local.json." And then all you have to do is switch out your own API key.
8. Thanks, everyone.
Close: And as always, I appreciate you guys making it to the end of the video and I'll see you all in the next one. (`2OD14-0cot4` @ 15:36)

## B. Atomic Knowledge

### Opening claim
- **Claim:** So, I've been playing around with GLM 5.2 inside of Cloud Code all day and it's incredible.
...
- **Evidence:** SOURCE quote: “So, I've been playing around with GLM 5.2 inside of Cloud Code all day and it's incredible.”
...
- **Source:** `2OD14-0cot4` @ 0:00
- **Epistemic:** SOURCE
### Demo / proof move
- **Claim:** So, in today's video, I'm going to show you just how quick and easy you can get set up with GLM 5.2 in Cloud Code.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “So, in today's video, I'm going to show you just how quick and easy you can get set up with GLM 5.2 in Cloud Code.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
...
- **Source:** `2OD14-0cot4` @ 0:12
- **Epistemic:** SOURCE
### Pricing or scale claim
- **Claim:** It was GLM 5.2 1 million context, as you can see right here.
- **Reasoning:** Speaker used a number to prove value or close a CTA.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “It was GLM 5.2 1 million context, as you can see right here.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Label UNVERIFIED. Steal the *structure* (didn’t-send, napkin, package), not the number.
- **Confidence:** low as FACT
- **Source:** `2OD14-0cot4` @ 0:32
- **Epistemic:** SOURCE
### Warning / hedge
- **Claim:** And generally the way that I feel about this so far is that GLM 5.2 is really solid and it's pretty quick for most tasks that don't require heavy reasoning.
- **Reasoning:** Speaker named a limit, hedge, or thing the agent should not do.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “And generally the way that I feel about this so far is that GLM 5.2 is really solid and it's pretty quick for most tasks that don't require heavy reasoning.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Keep the hedge as the desk. It is usually the steal.
- **Confidence:** high as SOURCE hedge; still not a ship
- **Source:** `2OD14-0cot4` @ 2:25
- **Epistemic:** SOURCE
### Close / CTA
- **Claim:** And as always, I appreciate you guys making it to the end of the video and I'll see you all in the next one.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “And as always, I appreciate you guys making it to the end of the video and I'll see you all in the next one.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Store the claim. Do not operate the payload. Challenge in H.
- **Confidence:** medium as SOURCE-of-speech; low as business fact
- **Source:** `2OD14-0cot4` @ 15:36
- **Epistemic:** SOURCE
...
- And then, there are some like this one where Opus would have done this much quicker. — `2OD14-0cot4` @ 0:42
- Especially when you consider the fact that you are getting this output for like five times cheaper. — `2OD14-0cot4` @ 1:26
- You can see right here we've got GLM and then right here we've got Opus 4.8. — `2OD14-0cot4` @ 1:59
- And then when they finished, I had Codex judge both results and tell us what it thought. — `2OD14-0cot4` @ 2:05
- And generally the way that I feel about this so far is that GLM 5.2 is really solid and it's pretty quick for most tasks that don't require heavy reasoning. — `2OD14-0cot4` @ 2:25
...
- **Situation:** So, I've been playing around with GLM 5.2 inside of Cloud Code all day and it's incredible.
- **Action:** You can see right here we've got GLM and then right here we've got Opus 4.8.
- **Reasoning:** Speaker treats the on-screen path as sufficient teaching.
- **Outcome:** First, the sentence is broken.
- **Lesson:** And generally the way that I feel about this so far is that GLM 5.2 is really solid and it's pretty quick for most tasks that don't require heavy reasoning.
- **Implicit rule:** If the demo cannot be re-opened as a file/URL/log, it is theater.
- **Source:** `2OD14-0cot4` @ 0:00 · Epistemic: SOURCE (walkthrough) + INFERENCE (lesson)

## F. Decision Rules

- Speaker hedge to keep: And generally the way that I feel about this so far is that GLM 5.2 is really solid and it's pretty quick for most tasks that don't require heavy reasoning.
...
- **Tape $ / counts UNVERIFIED:** 1 million, 20%, 80%, $60, 5 hours, 10%, 100%, 753 billion. Speaker said or implied them; I do not promote them to FACT, price analog, or Path A MUST.
