...
**Walk:** 2026-08-14 re-walk · Nate 82 shortlist · short · 1:54 · 434 words

## A. Source Map

Speaker/channel: **Nate Herk | AI Automation**. Title: *Build Your First Voice AI Agent with Vapi and n8n  #artificialintelligence #aiagent*. Kind: short. Duration: 1:54. Caption words: 434. Corpus tag: Nate 82 shortlist.
...
1. Here's how to build your first voice agent with Vappy and Naden.
2. Create event and check availability.
3. Hang tight.
...
### Opening claim
- **Claim:** Here's how to build your first voice agent with Vappy and Naden.
...
- **Evidence:** SOURCE quote: “Here's how to build your first voice agent with Vappy and Naden.”
...
- **Source:** `G9Ho8n4lD6I` @ 0:00
- **Epistemic:** SOURCE
### Demo / proof move
- **Claim:** I'm going to go ahead and click on create new assistant and we're going to do blank and I'm just going to call this one a booking agent.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “I'm going to go ahead and click on create new assistant and we're going to do blank and I'm just going to call this one a booking agent.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Store the claim. Do not operate the payload. Challenge in H.
- **Confidence:** medium as SOURCE-of-speech; low as business fact
- **Source:** `G9Ho8n4lD6I` @ 0:03
- **Epistemic:** SOURCE
### Close / CTA
...
- **Action:** Store the claim. Do not operate the payload. Challenge in H.
- **Confidence:** medium as SOURCE-of-speech; low as business fact
- **Source:** `G9Ho8n4lD6I` @ 1:46
- **Epistemic:** SOURCE
### Tape claim
- **Claim:** Basically, what I want this agent to do is let's say I'm running a car detailing company called Hercules Detailing.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “Basically, what I want this agent to do is let's say I'm running a car detailing company called Hercules Detailing.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Store the claim. Do not operate the payload. Challenge in H.
- **Confidence:** medium as SOURCE-of-speech; low as business fact
- **Source:** `G9Ho8n4lD6I` @ 0:06
- **Epistemic:** SOURCE
### Tape claim
- **Claim:** We are going to system prompt this thing so that someone could call the the phone number on hercules detailing.com and book in an appointment.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “We are going to system prompt this thing so that someone could call the the phone number on hercules detailing.com and book in an appointment.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Store the claim. Do not operate the payload. Challenge in H.
- **Confidence:** medium as SOURCE-of-speech; low as business fact
- **Source:** `G9Ho8n4lD6I` @ 0:14
- **Epistemic:** SOURCE
...
- Here's how to build your first voice agent with Vappy and Naden. — `G9Ho8n4lD6I` @ 0:00
- So you can see we have an overview, we have a purpose, we have the service options, and the one thing I just want to make sure we have here is when to use each tool. — `G9Ho8n4lD6I` @ 0:52
- If you want to watch the full breakdown, then click on that play button right here. — `G9Ho8n4lD6I` @ 1:46
...
- **Situation:** Here's how to build your first voice agent with Vappy and Naden.
- **Action:** Create event and check availability.
- **Reasoning:** Speaker treats the on-screen path as sufficient teaching.
- **Outcome:** Hang tight.
- **Lesson:** So you can see we have an overview, we have a purpose, we have the service options, and the one thing I just want to make sure we have here is when to use each tool.
- **Implicit rule:** If the demo cannot be re-opened as a file/URL/log, it is theater.
- **Source:** `G9Ho8n4lD6I` @ 0:00 · Epistemic: SOURCE (walkthrough) + INFERENCE (lesson)

## F. Decision Rules

- Speaker hedge to keep: So you can see we have an overview, we have a purpose, we have the service options, and the one thing I just want to make sure we have here is when to use each tool.
...
- Does the pair tape (zWLZ3bVVwD8) contradict a hedge on this cut?
...
- Paired / overlapping titles on disk: `zWLZ3bVVwD8`. Walk both; do not ship from the short.
...
- Teaser. I steal **confirmation email is a send**, not the 5 p.m. slot.
- **FLAG: book + email in one breath.** Short is the leak. Auto-book remains operate-never. Long tape has credits/pricing; this cut is the hard step only.
