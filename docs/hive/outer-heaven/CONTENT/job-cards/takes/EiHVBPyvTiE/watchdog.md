...
**Walk:** 2026-08-14 re-walk · Nate 82 shortlist · short · 1:32 · 420 words

## A. Source Map

Speaker/channel: **Nate Herk | AI Automation**. Title: *Build ANYTHING with Gemini 3 Pro and n8n AI Agents  #artificialintelligence #aiagent*. Kind: short. Duration: 1:32. Caption words: 420. Corpus tag: Nate 82 shortlist.
...
1. Here's how you can build anything with Gemini 3 Pro and Naden.
2. And there's a few different ways.
3. And you would just need to copy that and then go ahead and throw that right here into Nen.
4. And I'll see you guys over there.
Close: If you want to watch the full breakdown, then click on that play button right here. (`EiHVBPyvTiE` @ 1:25)

## B. Atomic Knowledge

### Opening claim
- **Claim:** Here's how you can build anything with Gemini 3 Pro and Naden.
...
- **Evidence:** SOURCE quote: “Here's how you can build anything with Gemini 3 Pro and Naden.”
...
- **Source:** `EiHVBPyvTiE` @ 0:00
- **Epistemic:** SOURCE
### Demo / proof move
- **Claim:** As you can see, we have Gemini 3 Pro preview.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “As you can see, we have Gemini 3 Pro preview.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Store the claim. Do not operate the payload. Challenge in H.
- **Confidence:** medium as SOURCE-of-speech; low as business fact
- **Source:** `EiHVBPyvTiE` @ 0:10
- **Epistemic:** SOURCE
### Warning / hedge
- **Claim:** But first, what I want to do is just show you guys if you've never connected to Gemini before, how do you do it in edit?
- **Reasoning:** Speaker named a limit, hedge, or thing the agent should not do.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “But first, what I want to do is just show you guys if you've never connected to Gemini before, how do you do it in edit?”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Keep the hedge as the desk. It is usually the steal.
- **Confidence:** high as SOURCE hedge; still not a ship
- **Source:** `EiHVBPyvTiE` @ 0:22
- **Epistemic:** SOURCE
### Close / CTA
...
- **Action:** Store the claim. Do not operate the payload. Challenge in H.
- **Confidence:** medium as SOURCE-of-speech; low as business fact
- **Source:** `EiHVBPyvTiE` @ 1:25
- **Epistemic:** SOURCE
### Tape claim
- **Claim:** And it's really cool because if you click over on the build section and go to gallery, you can see what you can do with Gemini 3 Pro.
- **Reasoning:** Speaker offered this as how the system works or why a viewer should believe the demo.
- **Mechanism:** Talk + on-screen walkthrough. Not an independent receipt.
- **Evidence:** SOURCE quote: “And it's really cool because if you click over on the build section and go to gallery, you can see what you can do with Gemini 3 Pro.”
- **Conditions:** If the viewer treats the captioned demo as the whole method.
- **Exceptions:** If the long-form pair, a fail, or a later hedge contradicts the teaser.
- **Action:** Store the claim. Do not operate the payload. Challenge in H.
- **Confidence:** medium as SOURCE-of-speech; low as business fact
- **Source:** `EiHVBPyvTiE` @ 0:12
- **Epistemic:** SOURCE
...
- And it's really cool because if you click over on the build section and go to gallery, you can see what you can do with Gemini 3 Pro. — `EiHVBPyvTiE` @ 0:12
- But first, what I want to do is just show you guys if you've never connected to Gemini before, how do you do it in edit? — `EiHVBPyvTiE` @ 0:22
- So the first way is you go ahead and just type in Gemini and you can pull up the Google Gemini node itself. — `EiHVBPyvTiE` @ 0:29
- And so if you choose one of these operations, what it's going to ask you to do is create a credential where you would basically need to go get a Gemini API key. — `EiHVBPyvTiE` @ 0:39
- And you would just need to copy that and then go ahead and throw that right here into Nen. — `EiHVBPyvTiE` @ 1:00
...
- **Situation:** Here's how you can build anything with Gemini 3 Pro and Naden.
- **Action:** And there's a few different ways.
- **Reasoning:** Speaker treats the on-screen path as sufficient teaching.
- **Outcome:** And you would just need to copy that and then go ahead and throw that right here into Nen.
- **Lesson:** But first, what I want to do is just show you guys if you've never connected to Gemini before, how do you do it in edit?
- **Implicit rule:** If the demo cannot be re-opened as a file/URL/log, it is theater.
- **Source:** `EiHVBPyvTiE` @ 0:00 · Epistemic: SOURCE (walkthrough) + INFERENCE (lesson)

## F. Decision Rules

- Speaker hedge to keep: But first, what I want to do is just show you guys if you've never connected to Gemini before, how do you do it in edit?
...
- Does the pair tape (Vb1SwBAn9cQ) contradict a hedge on this cut?
...
- Paired / overlapping titles on disk: `Vb1SwBAn9cQ`. Walk both; do not ship from the short.
...
### Machine: teaser hedge, walk the long
...
- **Procedure:** Steal the named caution. Do not ship from the short. Run D. Fail-closed before send/pay/deploy/book/publish.
...
- **Operate-never payload:** short payload may be non-empty (vendor / dial / post / jackpot / School). Machine still stolen.
...
- Teaser. I steal **key ≠ ship**, not “build anything.”
- **FLAG: credential demo as a smoke.** Billing key is a pay surface, not a fixture. Long tape has the tool-call hedge.
...
- **Challenge job (§8):** I keep the disagreements in H. I still steal **teaser hedge, walk the long**.
