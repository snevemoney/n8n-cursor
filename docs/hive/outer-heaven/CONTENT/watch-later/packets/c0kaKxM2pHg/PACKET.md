# Ingest — Nate Herk The Skill That 10x’d My Claude Code Projects

**Video id:** `c0kaKxM2pHg`  
**URL:** https://www.youtube.com/watch?v=c0kaKxM2pHg  
**Title:** The Skill That 10x’d My Claude Code Projects  
**Channel:** Nate Herk | AI Automation  
**Kind:** video  
**Duration:** 7:24  
**Captions:** yt-dlp `en-orig` json3 — **1854 words**. Not invented.  
**Date:** 2026-08-14  
**Uploaded:** 2026-06-04  
...
```
/Users/evenslouis/n8n-cursor/docs/hive/outer-heaven/CONTENT/watch-later/packets/c0kaKxM2pHg/full.txt
```

Mirror (same bytes): `docs/hive/outer-heaven/CONTENT/watch-later/packets/c0kaKxM2pHg/transcripts/full.txt`  
VTT/json3: `docs/hive/outer-heaven/CONTENT/watch-later/packets/c0kaKxM2pHg/transcripts/c0kaKxM2pHg.en-orig.json3`

## Transcript said (pointer — read full.txt)

Caption ingest only. Read `full.txt` (1854 words). No invented summary. 17 desks not spawned.
