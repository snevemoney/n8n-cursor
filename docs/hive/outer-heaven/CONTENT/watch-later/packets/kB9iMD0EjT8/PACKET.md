# Ingest — Nate Herk How to Use Your Claude Code Projects in Codex in 5 Mins

**Video id:** `kB9iMD0EjT8`  
**URL:** https://www.youtube.com/watch?v=kB9iMD0EjT8  
**Title:** How to Use Your Claude Code Projects in Codex in 5 Mins  
**Channel:** Nate Herk | AI Automation  
**Kind:** video  
**Duration:** 8:39  
**Captions:** yt-dlp `en-orig` json3 — **2202 words**. Not invented.  
**Date:** 2026-08-14  
**Uploaded:** 2026-05-18  
...
```
/Users/evenslouis/n8n-cursor/docs/hive/outer-heaven/CONTENT/watch-later/packets/kB9iMD0EjT8/full.txt
```

Mirror (same bytes): `docs/hive/outer-heaven/CONTENT/watch-later/packets/kB9iMD0EjT8/transcripts/full.txt`  
VTT/json3: `docs/hive/outer-heaven/CONTENT/watch-later/packets/kB9iMD0EjT8/transcripts/kB9iMD0EjT8.en-orig.json3`

## Transcript said (pointer — read full.txt)

Caption ingest only. Read `full.txt` (2202 words). No invented summary. 17 desks not spawned.
