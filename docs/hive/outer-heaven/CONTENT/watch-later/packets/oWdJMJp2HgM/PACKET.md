# Ingest — Nate Herk n8n JUST Leveled Up AI Agents With Guardrails: Here's How It Works

**Video id:** `oWdJMJp2HgM`  
...
**Kind:** video  
**Duration:** 14:38  
**Captions:** yt-dlp `en-orig` json3 — **3464 words**. Not invented.  
**Date:** 2026-08-14  
**Uploaded:** 2025-11-11  
...
```
/Users/evenslouis/n8n-cursor/docs/hive/outer-heaven/CONTENT/watch-later/packets/oWdJMJp2HgM/full.txt
```

Mirror (same bytes): `docs/hive/outer-heaven/CONTENT/watch-later/packets/oWdJMJp2HgM/transcripts/full.txt`  
VTT/json3: `docs/hive/outer-heaven/CONTENT/watch-later/packets/oWdJMJp2HgM/transcripts/oWdJMJp2HgM.en-orig.json3`

## Transcript said (pointer — read full.txt)

Caption ingest only. Read `full.txt` (3464 words). No invented summary. 17 desks not spawned.
