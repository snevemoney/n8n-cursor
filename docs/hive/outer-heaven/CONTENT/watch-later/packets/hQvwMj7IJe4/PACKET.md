# Ingest — Nate Herk Fable 5 + Karpathy’s LLM Wiki is Basically Cheating
...
**Kind:** video  
**Duration:** 14:35  
**Captions:** yt-dlp `en-orig` json3 — **3719 words**. Not invented.  
**Date:** 2026-08-14  
**Uploaded:** 2026-07-03  
...
```
/Users/evenslouis/n8n-cursor/docs/hive/outer-heaven/CONTENT/watch-later/packets/hQvwMj7IJe4/full.txt
```

Mirror (same bytes): `docs/hive/outer-heaven/CONTENT/watch-later/packets/hQvwMj7IJe4/transcripts/full.txt`  
VTT/json3: `docs/hive/outer-heaven/CONTENT/watch-later/packets/hQvwMj7IJe4/transcripts/hQvwMj7IJe4.en-orig.json3`

## Transcript said (pointer — read full.txt)

Caption ingest only. Read `full.txt` (3719 words). No invented summary. 17 desks not spawned.
