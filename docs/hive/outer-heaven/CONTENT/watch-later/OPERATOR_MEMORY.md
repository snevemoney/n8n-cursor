...
- **FACT (run today):** Each `icp_id` has a runbook at `CONTENT/icp-runbooks/{icp_id}.md` — Path, machine, skill chain, SKU band, **Today** (3 actions). Skill `icp-runbook`. Index: `CONTENT/icp-runbooks/INDEX.md`.
