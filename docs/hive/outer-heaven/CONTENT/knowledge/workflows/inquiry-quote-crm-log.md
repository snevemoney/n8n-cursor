# Workflow — inquiry-quote-crm-log
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** inquiry-quote-crm-log
**Tape:** `D-OOsl8C4Ns` · caption-only · 147 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-D-OOsl8C4Ns-01, K-D-OOsl8C4Ns-02
...
- **Transcript:** `packets/D-OOsl8C4Ns/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `inquiry-quote-crm-log` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/D-OOsl8C4Ns/full.txt`
