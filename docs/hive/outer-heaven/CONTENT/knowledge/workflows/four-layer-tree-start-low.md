# Workflow — four-layer-tree-start-low
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** four-layer tree; start low
**Tape:** `4OOS96i2gfI` · caption-only · 2461 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-4OOS96i2gfI-01, K-4OOS96i2gfI-02, K-4OOS96i2gfI-03
...
- **Transcript:** `packets/4OOS96i2gfI/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `four-layer-tree-start-low` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-4OOS96i2gfI-01, K-4OOS96i2gfI-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/4OOS96i2gfI/full.txt`
