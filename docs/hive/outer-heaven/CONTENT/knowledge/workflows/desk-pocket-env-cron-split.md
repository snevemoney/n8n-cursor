# Workflow — desk-pocket-env-cron-split
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** desk-pocket-env-cron-split
**Tape:** `gb5TlGw6Uks` · caption-only · 14572 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-gb5TlGw6Uks-01, K-gb5TlGw6Uks-02, K-gb5TlGw6Uks-03
...
- **Transcript:** `packets/gb5TlGw6Uks/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `desk-pocket-env-cron-split` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-gb5TlGw6Uks-01, K-gb5TlGw6Uks-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/gb5TlGw6Uks/full.txt`
