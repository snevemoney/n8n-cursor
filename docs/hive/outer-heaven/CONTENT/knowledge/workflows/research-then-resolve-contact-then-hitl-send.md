# Workflow — research-then-resolve-contact-then-hitl-send
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** research-then-resolve-contact-then-hitl-send
**Tape:** `nQtogLs_dlg` · caption-only · 450 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-nQtogLs_dlg-01, K-nQtogLs_dlg-02, K-nQtogLs_dlg-03, K-nQtogLs_dlg-04
- **dissent_ids:** K-nQtogLs_dlg-05, K-nQtogLs_dlg-06
...
- **Transcript:** `packets/nQtogLs_dlg/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `research-then-resolve-contact-then-hitl-send` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-nQtogLs_dlg-01, K-nQtogLs_dlg-02
- **dissent_ids:** K-nQtogLs_dlg-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/nQtogLs_dlg/full.txt`
...
- **dissent kept visible:** K-nQtogLs_dlg-05, K-nQtogLs_dlg-06
