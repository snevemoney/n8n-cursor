# Workflow — boring-six-as-shapes-not-installs
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** boring-six-as-shapes-not-installs
**Tape:** `eRS3CmvrOvA` · caption-only · 3401 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-eRS3CmvrOvA-01, K-eRS3CmvrOvA-02, K-eRS3CmvrOvA-03, K-eRS3CmvrOvA-04
...
- **Transcript:** `packets/eRS3CmvrOvA/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `boring-six-as-shapes-not-installs` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-eRS3CmvrOvA-01, K-eRS3CmvrOvA-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/eRS3CmvrOvA/full.txt`
