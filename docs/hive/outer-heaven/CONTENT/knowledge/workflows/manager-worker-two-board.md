# Workflow — manager-worker-two-board
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** manager-worker-two-board
**Tape:** `EthxaDswUFo` · caption-only · 4609 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-EthxaDswUFo-01, K-EthxaDswUFo-02, K-EthxaDswUFo-03
...
- **Transcript:** `packets/EthxaDswUFo/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `manager-worker-two-board` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-EthxaDswUFo-01, K-EthxaDswUFo-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/EthxaDswUFo/full.txt`
