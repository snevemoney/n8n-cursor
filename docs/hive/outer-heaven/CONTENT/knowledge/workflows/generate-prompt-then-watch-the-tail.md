# Workflow — generate-prompt-then-watch-the-tail
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** generate-prompt-then-watch-the-tail
**Tape:** `NO97pqqc10A` · caption-only · 99 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-NO97pqqc10A-01, K-NO97pqqc10A-02
...
- **Transcript:** `packets/NO97pqqc10A/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `generate-prompt-then-watch-the-tail` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/NO97pqqc10A/full.txt`
