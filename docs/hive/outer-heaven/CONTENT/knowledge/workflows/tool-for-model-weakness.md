# Workflow — tool-for-model-weakness
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** tool-for-model-weakness
**Tape:** `NWbh5ZoEHkA` · caption-only · 67 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-NWbh5ZoEHkA-01, K-NWbh5ZoEHkA-02
...
- **Transcript:** `packets/NWbh5ZoEHkA/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `tool-for-model-weakness` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/NWbh5ZoEHkA/full.txt`
