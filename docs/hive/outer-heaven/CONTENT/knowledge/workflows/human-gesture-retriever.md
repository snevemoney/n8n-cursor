# Workflow — human-gesture-retriever
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** human-gesture-retriever
**Tape:** `kOKavHnlPik` · caption-only · 4209 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-kOKavHnlPik-01, K-kOKavHnlPik-02, K-kOKavHnlPik-03, K-kOKavHnlPik-04
- **dissent_ids:** K-kOKavHnlPik-05, K-kOKavHnlPik-06, K-kOKavHnlPik-07, K-kOKavHnlPik-08
...
- **Transcript:** `packets/kOKavHnlPik/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `human-gesture-retriever` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-kOKavHnlPik-01, K-kOKavHnlPik-02
- **dissent_ids:** K-kOKavHnlPik-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/kOKavHnlPik/full.txt`
...
- **dissent kept visible:** K-kOKavHnlPik-05, K-kOKavHnlPik-06, K-kOKavHnlPik-07, K-kOKavHnlPik-08
