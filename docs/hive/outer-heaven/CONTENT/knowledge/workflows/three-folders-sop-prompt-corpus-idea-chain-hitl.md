# Workflow — three-folders-sop-prompt-corpus-idea-chain-hitl
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** three-folders → SOP-prompt → corpus+idea → chain → HITL
**Tape:** `0YXjEzFfft8` · caption-only · 12802 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-0YXjEzFfft8-01, K-0YXjEzFfft8-02, K-0YXjEzFfft8-03, K-0YXjEzFfft8-04
- **dissent_ids:** K-0YXjEzFfft8-05, K-0YXjEzFfft8-06
...
- **Transcript:** `packets/0YXjEzFfft8/transcripts/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `three-folders-sop-prompt-corpus-idea-chain-hitl` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-0YXjEzFfft8-01, K-0YXjEzFfft8-02
- **dissent_ids:** K-0YXjEzFfft8-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/0YXjEzFfft8/transcripts/full.txt`
...
- **dissent kept visible:** K-0YXjEzFfft8-05, K-0YXjEzFfft8-06
