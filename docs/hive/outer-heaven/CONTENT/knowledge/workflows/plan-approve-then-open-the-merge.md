# Workflow — plan-approve-then-open-the-merge
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** plan-approve-then-open-the-merge
**Tape:** `TDHFkKSTJ30` · caption-only · 4694 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-TDHFkKSTJ30-01, K-TDHFkKSTJ30-02, K-TDHFkKSTJ30-03
...
- **Transcript:** `packets/TDHFkKSTJ30/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `plan-approve-then-open-the-merge` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-TDHFkKSTJ30-01, K-TDHFkKSTJ30-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/TDHFkKSTJ30/full.txt`
