# Workflow — roast-verify-handoff-goal
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** roast-verify-handoff-goal
**Tape:** `iTY8Q449YNQ` · caption-only · 7392 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-iTY8Q449YNQ-01, K-iTY8Q449YNQ-02, K-iTY8Q449YNQ-03
...
- **Transcript:** `packets/iTY8Q449YNQ/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `roast-verify-handoff-goal` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-iTY8Q449YNQ-01, K-iTY8Q449YNQ-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/iTY8Q449YNQ/full.txt`
