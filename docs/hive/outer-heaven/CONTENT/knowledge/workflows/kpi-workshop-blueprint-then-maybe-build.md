# Workflow — kpi-workshop-blueprint-then-maybe-build
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** kpi-workshop-blueprint-then-maybe-build
**Tape:** `8ktcSaSTvxk` · caption-only · 21121 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-8ktcSaSTvxk-01, K-8ktcSaSTvxk-02, K-8ktcSaSTvxk-03, K-8ktcSaSTvxk-04
- **dissent_ids:** K-8ktcSaSTvxk-05, K-8ktcSaSTvxk-06
...
- **Transcript:** `packets/8ktcSaSTvxk/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `kpi-workshop-blueprint-then-maybe-build` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-8ktcSaSTvxk-01, K-8ktcSaSTvxk-02
- **dissent_ids:** K-8ktcSaSTvxk-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/8ktcSaSTvxk/full.txt`
...
- **dissent kept visible:** K-8ktcSaSTvxk-05, K-8ktcSaSTvxk-06
