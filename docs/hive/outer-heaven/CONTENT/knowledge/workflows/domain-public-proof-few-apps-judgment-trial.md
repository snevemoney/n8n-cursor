# Workflow — domain-public-proof-few-apps-judgment-trial
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** domain + public-proof → few apps → judgment-trial
**Tape:** `diY71x7GUjI` · caption-only · 7793 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-diY71x7GUjI-01, K-diY71x7GUjI-02, K-diY71x7GUjI-03
...
- **Transcript:** `packets/diY71x7GUjI/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `domain-public-proof-few-apps-judgment-trial` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-diY71x7GUjI-01, K-diY71x7GUjI-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/diY71x7GUjI/full.txt`
