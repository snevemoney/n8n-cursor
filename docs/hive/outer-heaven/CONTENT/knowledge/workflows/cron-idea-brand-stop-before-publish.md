# Workflow — cron-idea-brand-stop-before-publish
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** cron-idea-brand-stop-before-publish
**Tape:** `tNOk29fs_aY` · caption-only · 367 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-tNOk29fs_aY-01, K-tNOk29fs_aY-02, K-tNOk29fs_aY-03, K-tNOk29fs_aY-04
- **dissent_ids:** K-tNOk29fs_aY-05, K-tNOk29fs_aY-06, K-tNOk29fs_aY-07, K-tNOk29fs_aY-08
...
- **Transcript:** `packets/tNOk29fs_aY/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `cron-idea-brand-stop-before-publish` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-tNOk29fs_aY-01, K-tNOk29fs_aY-02
- **dissent_ids:** K-tNOk29fs_aY-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/tNOk29fs_aY/full.txt`
...
- **dissent kept visible:** K-tNOk29fs_aY-05, K-tNOk29fs_aY-06, K-tNOk29fs_aY-07, K-tNOk29fs_aY-08
