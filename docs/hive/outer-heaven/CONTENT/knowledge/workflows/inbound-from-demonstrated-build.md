# Workflow — inbound-from-demonstrated-build
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** inbound-from-demonstrated-build
**Tape:** `x-2088007687149601254` · caption-only · 2127 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-x-2088007687149601254-01, K-x-2088007687149601254-02, K-x-2088007687149601254-03, K-x-2088007687149601254-04
- **dissent_ids:** K-x-2088007687149601254-05
...
- **Transcript:** `packets/x-2088007687149601254/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `inbound-from-demonstrated-build` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-x-2088007687149601254-01, K-x-2088007687149601254-02
- **dissent_ids:** K-x-2088007687149601254-05
...
- **pattern_ids:** none — hive skill
- **support_ids:** K-x-2088007687149601254-04
- **dissent_ids:** none
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/x-2088007687149601254/full.txt`
...
- **dissent kept visible:** K-x-2088007687149601254-05
