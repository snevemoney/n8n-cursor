# Workflow — post-publish-moneyball-party
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** post-publish-moneyball-party
**Tape:** `FHsY924cEAk` · caption-only · 4536 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-FHsY924cEAk-01, K-FHsY924cEAk-02, K-FHsY924cEAk-03
...
- **Transcript:** `packets/FHsY924cEAk/transcripts/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `post-publish-moneyball-party` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-FHsY924cEAk-01, K-FHsY924cEAk-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/FHsY924cEAk/transcripts/full.txt`
