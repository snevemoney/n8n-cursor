# Workflow — diagnose-hours-then-fraction-price
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** diagnose-hours-then-fraction-price
**Tape:** `YF0XPMXLHOA` · caption-only · 222 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-YF0XPMXLHOA-01, K-YF0XPMXLHOA-02, K-YF0XPMXLHOA-03
...
- **Transcript:** `packets/YF0XPMXLHOA/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `diagnose-hours-then-fraction-price` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-YF0XPMXLHOA-01, K-YF0XPMXLHOA-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/YF0XPMXLHOA/full.txt`
