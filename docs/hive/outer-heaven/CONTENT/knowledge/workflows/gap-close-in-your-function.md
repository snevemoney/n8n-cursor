# Workflow — gap-close-in-your-function
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** gap-close-in-your-function
**Tape:** `iIfOprq2kCM` · caption-only · 4345 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-iIfOprq2kCM-01, K-iIfOprq2kCM-02, K-iIfOprq2kCM-03
...
- **Transcript:** `packets/iIfOprq2kCM/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `gap-close-in-your-function` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-iIfOprq2kCM-01, K-iIfOprq2kCM-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/iIfOprq2kCM/full.txt`
