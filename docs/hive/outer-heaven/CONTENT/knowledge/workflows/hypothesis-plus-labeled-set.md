# Workflow — hypothesis-plus-labeled-set
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** hypothesis-plus-labeled-set
**Tape:** `8IUWeF3B-hk` · caption-only · 332 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-8IUWeF3B-hk-01, K-8IUWeF3B-hk-02
...
- **Transcript:** `packets/8IUWeF3B-hk/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `hypothesis-plus-labeled-set` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/8IUWeF3B-hk/full.txt`
