# Workflow — responses-brain-tools-vs-agent-tools
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** responses-brain-tools-vs-agent-tools
**Tape:** `lokbsA5VXOk` · caption-only · 2655 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-lokbsA5VXOk-01, K-lokbsA5VXOk-02, K-lokbsA5VXOk-03, K-lokbsA5VXOk-04
- **dissent_ids:** K-lokbsA5VXOk-05, K-lokbsA5VXOk-06, K-lokbsA5VXOk-07, K-lokbsA5VXOk-08
...
- **Transcript:** `packets/lokbsA5VXOk/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `responses-brain-tools-vs-agent-tools` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-lokbsA5VXOk-01, K-lokbsA5VXOk-02
- **dissent_ids:** K-lokbsA5VXOk-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/lokbsA5VXOk/full.txt`
...
- **dissent kept visible:** K-lokbsA5VXOk-05, K-lokbsA5VXOk-06, K-lokbsA5VXOk-07, K-lokbsA5VXOk-08
