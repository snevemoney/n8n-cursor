# Workflow — treat-promo-as-sample-keep-portable
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** treat-promo-as-sample-keep-portable
**Tape:** `-nG-9vlSkho` · caption-only · 1874 words read
**Compiled:** 2026-08-14
...
- **Transcript:** `packets/-nG-9vlSkho/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `treat-promo-as-sample-keep-portable` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/-nG-9vlSkho/full.txt`
