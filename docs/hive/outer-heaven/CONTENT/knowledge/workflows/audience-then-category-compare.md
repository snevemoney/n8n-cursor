# Workflow — audience-then-category-compare
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** audience-then-category-compare
**Tape:** `-6yUeJ3rkvg` · caption-only · 436 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K--6yUeJ3rkvg-01, K--6yUeJ3rkvg-02
...
- **IF:** IF the tape machine is this `audience-then-category-compare` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/-6yUeJ3rkvg/full.txt`
