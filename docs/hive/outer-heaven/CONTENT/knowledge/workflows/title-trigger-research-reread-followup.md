# Workflow — title-trigger-research-reread-followup
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** title-trigger-research-reread-followup
**Tape:** `hN58VkYLie4` · caption-only · 478 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-hN58VkYLie4-01, K-hN58VkYLie4-02
...
- **Transcript:** `packets/hN58VkYLie4/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `title-trigger-research-reread-followup` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/hN58VkYLie4/full.txt`
