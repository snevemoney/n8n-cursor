# Workflow — wireframe-status-deterministic-chase-ai-last-kic
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** wireframe-status → deterministic chase → AI-last kickoff
**Tape:** `bxGE_LXPyAU` · caption-only · 7729 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-bxGE_LXPyAU-01, K-bxGE_LXPyAU-02, K-bxGE_LXPyAU-03, K-bxGE_LXPyAU-04
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
- **Transcript:** `packets/bxGE_LXPyAU/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `wireframe-status-deterministic-chase-ai-last-kic` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-bxGE_LXPyAU-01, K-bxGE_LXPyAU-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/bxGE_LXPyAU/full.txt`
...
- **dissent kept visible:** none — caption-only speech≠behavior stays on LEARNED
