# Workflow — four-blanks-earned-ladder-case-then-niche
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** four-blanks + earned-ladder + case-then-niche
**Tape:** `LVAHYV4Xrto` · caption-only · 6563 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-LVAHYV4Xrto-01, K-LVAHYV4Xrto-02, K-LVAHYV4Xrto-03
...
- **Transcript:** `packets/LVAHYV4Xrto/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `four-blanks-earned-ladder-case-then-niche` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-LVAHYV4Xrto-01, K-LVAHYV4Xrto-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/LVAHYV4Xrto/full.txt`
