# Workflow — same-prompt-bench-stop-condition-blame-context-t
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** same-prompt-bench → stop-condition → blame-context-then-tokens
**Tape:** `2J3uX8iRNng` · caption-only · 6825 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-2J3uX8iRNng-01, K-2J3uX8iRNng-02, K-2J3uX8iRNng-03, K-2J3uX8iRNng-04
- **dissent_ids:** K-2J3uX8iRNng-05, K-2J3uX8iRNng-06
...
- **IF:** IF the tape machine is this `same-prompt-bench-stop-condition-blame-context-t` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-2J3uX8iRNng-01, K-2J3uX8iRNng-02
- **dissent_ids:** K-2J3uX8iRNng-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/2J3uX8iRNng/full.txt`
...
- **dissent kept visible:** K-2J3uX8iRNng-05, K-2J3uX8iRNng-06
