# Workflow — still-to-ugc-then-fidelity-check
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** still-to-ugc-then-fidelity-check
**Tape:** `uC5tDwGhyVA` · caption-only · 263 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-uC5tDwGhyVA-01, K-uC5tDwGhyVA-02, K-uC5tDwGhyVA-03, K-uC5tDwGhyVA-04
- **dissent_ids:** K-uC5tDwGhyVA-05, K-uC5tDwGhyVA-06
...
- **Transcript:** `packets/uC5tDwGhyVA/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `still-to-ugc-then-fidelity-check` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-uC5tDwGhyVA-01, K-uC5tDwGhyVA-02
- **dissent_ids:** K-uC5tDwGhyVA-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/uC5tDwGhyVA/full.txt`
...
- **dissent kept visible:** K-uC5tDwGhyVA-05, K-uC5tDwGhyVA-06
