# Workflow — toggle-search-allowlist-cite
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** toggle-search-allowlist-cite
**Tape:** `QrJhdTbK3TU` · caption-only · 464 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-QrJhdTbK3TU-01, K-QrJhdTbK3TU-02
...
- **Transcript:** `packets/QrJhdTbK3TU/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `toggle-search-allowlist-cite` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/QrJhdTbK3TU/full.txt`
