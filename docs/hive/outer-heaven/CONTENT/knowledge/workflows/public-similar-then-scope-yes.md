# Workflow — public-similar-then-scope-yes
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** public-similar-then-scope-yes
**Tape:** `5IM27lbCwjM` · caption-only · 136 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-5IM27lbCwjM-01, K-5IM27lbCwjM-02
...
- **Transcript:** `packets/5IM27lbCwjM/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `public-similar-then-scope-yes` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/5IM27lbCwjM/full.txt`
