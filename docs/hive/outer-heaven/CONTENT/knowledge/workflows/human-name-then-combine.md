# Workflow — human-name-then-combine
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** human-name-then-combine
**Tape:** `TWvjqpk3uSQ` · caption-only · 425 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-TWvjqpk3uSQ-01, K-TWvjqpk3uSQ-02
...
- **Transcript:** `packets/TWvjqpk3uSQ/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `human-name-then-combine` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/TWvjqpk3uSQ/full.txt`
