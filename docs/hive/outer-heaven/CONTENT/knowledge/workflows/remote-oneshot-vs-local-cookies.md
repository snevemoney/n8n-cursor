# Workflow — remote-oneshot-vs-local-cookies
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** remote-oneshot-vs-local-cookies
**Tape:** `ehg4fhydTgs` · caption-only · 3970 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-ehg4fhydTgs-01, K-ehg4fhydTgs-02, K-ehg4fhydTgs-03
...
- **Transcript:** `packets/ehg4fhydTgs/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `remote-oneshot-vs-local-cookies` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-ehg4fhydTgs-01, K-ehg4fhydTgs-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/ehg4fhydTgs/full.txt`
