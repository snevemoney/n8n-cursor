# Workflow — two-calendar-tools-plus-when-to-use
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** two-calendar-tools-plus-when-to-use
**Tape:** `G9Ho8n4lD6I` · caption-only · 434 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-G9Ho8n4lD6I-01, K-G9Ho8n4lD6I-02
...
- **Transcript:** `packets/G9Ho8n4lD6I/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `two-calendar-tools-plus-when-to-use` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/G9Ho8n4lD6I/full.txt`
