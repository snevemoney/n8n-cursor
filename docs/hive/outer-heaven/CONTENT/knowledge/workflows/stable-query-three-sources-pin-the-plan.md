# Workflow — stable-query-three-sources-pin-the-plan
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** stable-query-three-sources-pin-the-plan
**Tape:** `0Ujdys4LqNs` · caption-only · 398 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-0Ujdys4LqNs-01, K-0Ujdys4LqNs-02
...
- **IF:** IF the tape machine is this `stable-query-three-sources-pin-the-plan` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/0Ujdys4LqNs/full.txt`
