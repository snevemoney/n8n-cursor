# Workflow — definition-then-three-scenarios-then-judgment
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** definition-then-three-scenarios-then-judgment
**Tape:** `NDeyhGnNECc` · caption-only · 2834 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-NDeyhGnNECc-01, K-NDeyhGnNECc-02, K-NDeyhGnNECc-03, K-NDeyhGnNECc-04
- **dissent_ids:** K-NDeyhGnNECc-05
...
- **Transcript:** `packets/NDeyhGnNECc/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `definition-then-three-scenarios-then-judgment` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-NDeyhGnNECc-01, K-NDeyhGnNECc-02
- **dissent_ids:** K-NDeyhGnNECc-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/NDeyhGnNECc/full.txt`
...
- **dissent kept visible:** K-NDeyhGnNECc-05
