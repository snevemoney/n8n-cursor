# Workflow — resolve-id-edit-then-read-the-pack
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** resolve-id-edit-then-read-the-pack
**Tape:** `UT_Ek_tmeVA` · caption-only · 302 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-UT_Ek_tmeVA-01, K-UT_Ek_tmeVA-02
...
- **Transcript:** `packets/UT_Ek_tmeVA/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `resolve-id-edit-then-read-the-pack` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/UT_Ek_tmeVA/full.txt`
