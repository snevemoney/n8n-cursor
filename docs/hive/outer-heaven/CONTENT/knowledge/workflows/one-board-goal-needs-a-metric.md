# Workflow — one-board-goal-needs-a-metric
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** one board; `/goal` needs a metric
**Tape:** `ZAaxx3qyT8g` · caption-only · 2123 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-ZAaxx3qyT8g-01, K-ZAaxx3qyT8g-02, K-ZAaxx3qyT8g-03
...
- **Transcript:** `packets/ZAaxx3qyT8g/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `one-board-goal-needs-a-metric` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-ZAaxx3qyT8g-01, K-ZAaxx3qyT8g-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/ZAaxx3qyT8g/full.txt`
