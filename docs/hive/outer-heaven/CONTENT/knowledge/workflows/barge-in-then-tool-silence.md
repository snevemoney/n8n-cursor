# Workflow — barge-in-then-tool-silence
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** barge-in-then-tool-silence
**Tape:** `Qt3zMBH-FNg` · caption-only · 4270 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-Qt3zMBH-FNg-01, K-Qt3zMBH-FNg-02, K-Qt3zMBH-FNg-03
...
- **Transcript:** `packets/Qt3zMBH-FNg/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `barge-in-then-tool-silence` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-Qt3zMBH-FNg-01, K-Qt3zMBH-FNg-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/Qt3zMBH-FNg/full.txt`
