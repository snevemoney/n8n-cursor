# Workflow — their-number-then-fraction-then-objective-pay
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** their-number-then-fraction-then-objective-pay
**Tape:** `Lg5TYWPSg6M` · caption-only · 5073 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-Lg5TYWPSg6M-01, K-Lg5TYWPSg6M-02, K-Lg5TYWPSg6M-03
...
- **Transcript:** `packets/Lg5TYWPSg6M/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `their-number-then-fraction-then-objective-pay` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-Lg5TYWPSg6M-01, K-Lg5TYWPSg6M-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/Lg5TYWPSg6M/full.txt`
