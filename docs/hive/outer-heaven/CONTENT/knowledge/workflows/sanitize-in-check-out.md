# Workflow — sanitize-in-check-out
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** sanitize-in-check-out
**Tape:** `oWdJMJp2HgM` · caption-only · 3464 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-oWdJMJp2HgM-01, K-oWdJMJp2HgM-02, K-oWdJMJp2HgM-03, K-oWdJMJp2HgM-04
- **dissent_ids:** K-oWdJMJp2HgM-05, K-oWdJMJp2HgM-06, K-oWdJMJp2HgM-07, K-oWdJMJp2HgM-08
...
- **Transcript:** `packets/oWdJMJp2HgM/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `sanitize-in-check-out` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-oWdJMJp2HgM-01, K-oWdJMJp2HgM-02
- **dissent_ids:** K-oWdJMJp2HgM-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/oWdJMJp2HgM/full.txt`
...
- **dissent kept visible:** K-oWdJMJp2HgM-05, K-oWdJMJp2HgM-06, K-oWdJMJp2HgM-07, K-oWdJMJp2HgM-08
