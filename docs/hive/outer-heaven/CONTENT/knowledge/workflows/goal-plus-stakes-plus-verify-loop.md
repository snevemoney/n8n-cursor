# Workflow — goal-plus-stakes-plus-verify-loop
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** goal-plus-stakes-plus-verify-loop
**Tape:** `ONmaDdOBGig` · caption-only · 1364 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-ONmaDdOBGig-01, K-ONmaDdOBGig-02
...
- **Transcript:** `packets/ONmaDdOBGig/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `goal-plus-stakes-plus-verify-loop` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/ONmaDdOBGig/full.txt`
