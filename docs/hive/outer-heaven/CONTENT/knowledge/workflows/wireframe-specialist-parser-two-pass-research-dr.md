# Workflow — wireframe-specialist-parser-two-pass-research-dr
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** wireframe → specialist-parser → two-pass research → draft-cite
**Tape:** `pxzo2lXhWJE` · caption-only · 6837 words read
**Compiled:** 2026-08-14
**Owners:** researcher, librarian
...
| T2 | Run named skill on Cursor+Grok | have hive skill | `deep-video-learning` |
...
- **pattern_ids:** none — hive skill `deep-video-learning`
- **support_ids:** K-pxzo2lXhWJE-01, K-pxzo2lXhWJE-02, K-pxzo2lXhWJE-03, K-pxzo2lXhWJE-04
- **dissent_ids:** K-pxzo2lXhWJE-05, K-pxzo2lXhWJE-06, K-pxzo2lXhWJE-07, K-pxzo2lXhWJE-08
...
- **Transcript:** `packets/pxzo2lXhWJE/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `wireframe-specialist-parser-two-pass-research-dr` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-pxzo2lXhWJE-01, K-pxzo2lXhWJE-02
- **dissent_ids:** K-pxzo2lXhWJE-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/pxzo2lXhWJE/full.txt`
...
- **dissent kept visible:** K-pxzo2lXhWJE-05, K-pxzo2lXhWJE-06, K-pxzo2lXhWJE-07, K-pxzo2lXhWJE-08
