# Workflow — diagnose-then-router-audit-then-backtrack
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** diagnose-then-router-audit-then-backtrack
**Tape:** `Ek1NBfnnTH0` · caption-only · 5985 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-Ek1NBfnnTH0-01, K-Ek1NBfnnTH0-02, K-Ek1NBfnnTH0-03
...
- **Transcript:** `packets/Ek1NBfnnTH0/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `diagnose-then-router-audit-then-backtrack` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-Ek1NBfnnTH0-01, K-Ek1NBfnnTH0-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/Ek1NBfnnTH0/full.txt`
