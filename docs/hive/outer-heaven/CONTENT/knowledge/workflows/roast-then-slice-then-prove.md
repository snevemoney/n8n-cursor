# Workflow — roast-then-slice-then-prove
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** roast-then-slice-then-prove
**Tape:** `pbrln2TVeh4` · caption-only · 2510 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-pbrln2TVeh4-01, K-pbrln2TVeh4-02, K-pbrln2TVeh4-03, K-pbrln2TVeh4-04
- **dissent_ids:** K-pbrln2TVeh4-05, K-pbrln2TVeh4-06, K-pbrln2TVeh4-07, K-pbrln2TVeh4-08
...
- **Transcript:** `packets/pbrln2TVeh4/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `roast-then-slice-then-prove` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-pbrln2TVeh4-01, K-pbrln2TVeh4-02
- **dissent_ids:** K-pbrln2TVeh4-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/pbrln2TVeh4/full.txt`
...
- **dissent kept visible:** K-pbrln2TVeh4-05, K-pbrln2TVeh4-06, K-pbrln2TVeh4-07, K-pbrln2TVeh4-08
