# Workflow — file-goal-tournament-then-red-team
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** file-goal-tournament-then-red-team
**Tape:** `R0qF17BVl9w` · caption-only · 2840 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-R0qF17BVl9w-01, K-R0qF17BVl9w-02, K-R0qF17BVl9w-03, K-R0qF17BVl9w-04
...
- **Transcript:** `packets/R0qF17BVl9w/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `file-goal-tournament-then-red-team` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-R0qF17BVl9w-01, K-R0qF17BVl9w-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/R0qF17BVl9w/full.txt`
