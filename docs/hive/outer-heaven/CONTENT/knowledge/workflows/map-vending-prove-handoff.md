# Workflow — map-vending-prove-handoff
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** map-vending-prove-handoff
**Tape:** `jdbOVepEtUE` · caption-only · 85931 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-jdbOVepEtUE-01, K-jdbOVepEtUE-02, K-jdbOVepEtUE-03, K-jdbOVepEtUE-04
- **dissent_ids:** K-jdbOVepEtUE-05, K-jdbOVepEtUE-06, K-jdbOVepEtUE-07, K-jdbOVepEtUE-08
...
- **Transcript:** `packets/jdbOVepEtUE/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `map-vending-prove-handoff` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-jdbOVepEtUE-01, K-jdbOVepEtUE-02
- **dissent_ids:** K-jdbOVepEtUE-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/jdbOVepEtUE/full.txt`
...
- **dissent kept visible:** K-jdbOVepEtUE-05, K-jdbOVepEtUE-06, K-jdbOVepEtUE-07, K-jdbOVepEtUE-08
