# Workflow — assigned-tools-not-whole-instance
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** assigned-tools-not-whole-instance
**Tape:** `9IzGe0BBj_c` · caption-only · 361 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-9IzGe0BBj_c-01, K-9IzGe0BBj_c-02
...
- **Transcript:** `packets/9IzGe0BBj_c/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `assigned-tools-not-whole-instance` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/9IzGe0BBj_c/full.txt`
