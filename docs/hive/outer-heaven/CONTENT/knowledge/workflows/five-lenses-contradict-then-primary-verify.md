# Workflow — five-lenses-contradict-then-primary-verify
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** five-lenses-contradict-then-primary-verify
**Tape:** `Tj3018n5MVg` · caption-only · 2963 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-Tj3018n5MVg-01, K-Tj3018n5MVg-02, K-Tj3018n5MVg-03, K-Tj3018n5MVg-04
...
- **Transcript:** `packets/Tj3018n5MVg/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `five-lenses-contradict-then-primary-verify` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-Tj3018n5MVg-01, K-Tj3018n5MVg-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/Tj3018n5MVg/full.txt`
