# Workflow — wrapper-not-weights
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** wrapper-not-weights
**Tape:** `brB-hSiV2iU` · caption-only · 3572 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-brB-hSiV2iU-01, K-brB-hSiV2iU-02, K-brB-hSiV2iU-03
...
- **Transcript:** `packets/brB-hSiV2iU/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `wrapper-not-weights` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-brB-hSiV2iU-01, K-brB-hSiV2iU-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/brB-hSiV2iU/full.txt`
