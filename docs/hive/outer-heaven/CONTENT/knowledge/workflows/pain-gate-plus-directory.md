# Workflow — pain-gate-plus-directory
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** pain-gate-plus-directory
**Tape:** `35WuZxbAY68` · caption-only · 4463 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-35WuZxbAY68-01, K-35WuZxbAY68-02, K-35WuZxbAY68-03, K-35WuZxbAY68-04
- **dissent_ids:** K-35WuZxbAY68-05
...
- **Transcript:** `packets/35WuZxbAY68/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `pain-gate-plus-directory` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-35WuZxbAY68-01, K-35WuZxbAY68-02
- **dissent_ids:** K-35WuZxbAY68-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/35WuZxbAY68/full.txt`
...
- **dissent kept visible:** K-35WuZxbAY68-05
