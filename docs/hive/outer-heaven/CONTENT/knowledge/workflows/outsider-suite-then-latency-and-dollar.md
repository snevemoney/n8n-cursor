# Workflow — outsider-suite-then-latency-and-dollar
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** outsider-suite-then-latency-and-dollar
**Tape:** `GpSqBjW6hR4` · caption-only · 2834 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-GpSqBjW6hR4-01, K-GpSqBjW6hR4-02, K-GpSqBjW6hR4-03, K-GpSqBjW6hR4-04
...
- **Transcript:** `packets/GpSqBjW6hR4/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `outsider-suite-then-latency-and-dollar` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-GpSqBjW6hR4-01, K-GpSqBjW6hR4-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/GpSqBjW6hR4/full.txt`
