# Workflow — question-lowest-level-evergreen-in-live-fetch
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** question→lowest-level → evergreen-in / live-fetch
**Tape:** `DTCyvo6cC54` · caption-only · 7561 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-DTCyvo6cC54-01, K-DTCyvo6cC54-02, K-DTCyvo6cC54-03
...
- **Transcript:** `packets/DTCyvo6cC54/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `question-lowest-level-evergreen-in-live-fetch` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-DTCyvo6cC54-01, K-DTCyvo6cC54-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/DTCyvo6cC54/full.txt`
