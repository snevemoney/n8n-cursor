# Workflow — log-poll-approve-preserve-hitl
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** log-poll-approve-preserve-hitl
**Tape:** `KGXFkUlBHxw` · caption-only · 5064 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-KGXFkUlBHxw-01, K-KGXFkUlBHxw-02, K-KGXFkUlBHxw-03
...
- **Transcript:** `packets/KGXFkUlBHxw/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `log-poll-approve-preserve-hitl` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-KGXFkUlBHxw-01, K-KGXFkUlBHxw-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/KGXFkUlBHxw/full.txt`
