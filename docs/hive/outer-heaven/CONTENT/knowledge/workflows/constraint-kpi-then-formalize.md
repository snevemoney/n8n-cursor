# Workflow — constraint-kpi-then-formalize
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** constraint-kpi-then-formalize
**Tape:** `-zL_trhnQaI` · caption-only · 4636 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K--zL_trhnQaI-01, K--zL_trhnQaI-02, K--zL_trhnQaI-03, K--zL_trhnQaI-04
- **dissent_ids:** K--zL_trhnQaI-05
...
- **Transcript:** `packets/-zL_trhnQaI/transcripts/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `constraint-kpi-then-formalize` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K--zL_trhnQaI-01, K--zL_trhnQaI-02
- **dissent_ids:** K--zL_trhnQaI-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/-zL_trhnQaI/transcripts/full.txt`
...
- **dissent kept visible:** K--zL_trhnQaI-05
