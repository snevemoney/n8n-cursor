# Workflow — problem-form-diagnose-email-book
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** problem-form-diagnose-email-book
**Tape:** `bX_stJ_Eiog` · caption-only · 563 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-bX_stJ_Eiog-01, K-bX_stJ_Eiog-02
...
- **Transcript:** `packets/bX_stJ_Eiog/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `problem-form-diagnose-email-book` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/bX_stJ_Eiog/full.txt`
