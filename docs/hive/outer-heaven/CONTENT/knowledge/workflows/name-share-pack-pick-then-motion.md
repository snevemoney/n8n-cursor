# Workflow — name-share-pack-pick-then-motion
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** name-share-pack-pick-then-motion
**Tape:** `IlNwjnIzrOo` · caption-only · 545 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-IlNwjnIzrOo-01, K-IlNwjnIzrOo-02, K-IlNwjnIzrOo-03
...
- **Transcript:** `packets/IlNwjnIzrOo/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `name-share-pack-pick-then-motion` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-IlNwjnIzrOo-01, K-IlNwjnIzrOo-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/IlNwjnIzrOo/full.txt`
