# Workflow — ai-authors-code-that-runs-without-tokens
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** ai-authors-code-that-runs-without-tokens
**Tape:** `i4Q8wHZNPBU` · caption-only · 1529 words read
**Compiled:** 2026-08-14
...
- **Transcript:** `packets/i4Q8wHZNPBU/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `ai-authors-code-that-runs-without-tokens` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/i4Q8wHZNPBU/full.txt`
