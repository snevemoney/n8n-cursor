# Workflow — managed-filesearch-four-http
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** managed-filesearch-four-http
**Tape:** `irg-2IfAjpo` · caption-only · 4696 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-irg-2IfAjpo-01, K-irg-2IfAjpo-02, K-irg-2IfAjpo-03, K-irg-2IfAjpo-04
- **dissent_ids:** K-irg-2IfAjpo-05, K-irg-2IfAjpo-06, K-irg-2IfAjpo-07, K-irg-2IfAjpo-08
...
- **Transcript:** `packets/irg-2IfAjpo/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `managed-filesearch-four-http` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-irg-2IfAjpo-01, K-irg-2IfAjpo-02
- **dissent_ids:** K-irg-2IfAjpo-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/irg-2IfAjpo/full.txt`
...
- **dissent kept visible:** K-irg-2IfAjpo-05, K-irg-2IfAjpo-06, K-irg-2IfAjpo-07, K-irg-2IfAjpo-08
