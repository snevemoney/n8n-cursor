# Workflow — table-as-control-plane-then-log-and-eval
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** table-as-control-plane-then-log-and-eval
**Tape:** `lcNN3X9gXls` · caption-only · 3791 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-lcNN3X9gXls-01, K-lcNN3X9gXls-02, K-lcNN3X9gXls-03, K-lcNN3X9gXls-04
- **dissent_ids:** K-lcNN3X9gXls-05, K-lcNN3X9gXls-06, K-lcNN3X9gXls-07, K-lcNN3X9gXls-08
...
- **Transcript:** `packets/lcNN3X9gXls/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `table-as-control-plane-then-log-and-eval` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-lcNN3X9gXls-01, K-lcNN3X9gXls-02
- **dissent_ids:** K-lcNN3X9gXls-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/lcNN3X9gXls/full.txt`
...
- **dissent kept visible:** K-lcNN3X9gXls-05, K-lcNN3X9gXls-06, K-lcNN3X9gXls-07, K-lcNN3X9gXls-08
