# Workflow — glance-idle-then-stop-or-load
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** glance-idle-then-stop-or-load
**Tape:** `62Rfe1w9NBc` · caption-only · 2945 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-62Rfe1w9NBc-01, K-62Rfe1w9NBc-02, K-62Rfe1w9NBc-03, K-62Rfe1w9NBc-04
...
- **Transcript:** `packets/62Rfe1w9NBc/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `glance-idle-then-stop-or-load` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-62Rfe1w9NBc-01, K-62Rfe1w9NBc-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/62Rfe1w9NBc/full.txt`
