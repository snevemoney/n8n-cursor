# Workflow — channel-router-plus-image-subflow
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** channel-router-plus-image-subflow
**Tape:** `7UNsK9LoORo` · caption-only · 4273 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-7UNsK9LoORo-01, K-7UNsK9LoORo-02, K-7UNsK9LoORo-03, K-7UNsK9LoORo-04
...
- **Transcript:** `packets/7UNsK9LoORo/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `channel-router-plus-image-subflow` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-7UNsK9LoORo-01, K-7UNsK9LoORo-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/7UNsK9LoORo/full.txt`
