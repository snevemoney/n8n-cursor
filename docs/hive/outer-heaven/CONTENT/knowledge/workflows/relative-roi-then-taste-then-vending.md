# Workflow — relative-roi-then-taste-then-vending
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** relative-roi-then-taste-then-vending
**Tape:** `3XIGcM7VICc` · caption-only · 5510 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-3XIGcM7VICc-01, K-3XIGcM7VICc-02, K-3XIGcM7VICc-03, K-3XIGcM7VICc-04
- **dissent_ids:** K-3XIGcM7VICc-05, K-3XIGcM7VICc-06
...
- **Transcript:** `packets/3XIGcM7VICc/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `relative-roi-then-taste-then-vending` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-3XIGcM7VICc-01, K-3XIGcM7VICc-02
- **dissent_ids:** K-3XIGcM7VICc-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/3XIGcM7VICc/full.txt`
...
- **dissent kept visible:** K-3XIGcM7VICc-05, K-3XIGcM7VICc-06
