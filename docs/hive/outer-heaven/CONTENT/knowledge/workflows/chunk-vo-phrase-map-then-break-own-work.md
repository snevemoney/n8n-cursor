# Workflow — chunk-vo-phrase-map-then-break-own-work
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** chunk-vo-phrase-map-then-break-own-work
**Tape:** `J_jswzXhYJA` · caption-only · 1137 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-J_jswzXhYJA-01, K-J_jswzXhYJA-02
...
- **Transcript:** `packets/J_jswzXhYJA/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `chunk-vo-phrase-map-then-break-own-work` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/J_jswzXhYJA/full.txt`
