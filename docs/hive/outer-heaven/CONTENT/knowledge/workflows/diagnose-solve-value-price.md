# Workflow — diagnose-solve-value-price
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** diagnose-solve-value-price
**Tape:** `w9-gfaV5vlM` · caption-only · 3377 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-w9-gfaV5vlM-01, K-w9-gfaV5vlM-02, K-w9-gfaV5vlM-03, K-w9-gfaV5vlM-04
- **dissent_ids:** K-w9-gfaV5vlM-05, K-w9-gfaV5vlM-06, K-w9-gfaV5vlM-07, K-w9-gfaV5vlM-08
...
- **Transcript:** `packets/w9-gfaV5vlM/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `diagnose-solve-value-price` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-w9-gfaV5vlM-01, K-w9-gfaV5vlM-02
- **dissent_ids:** K-w9-gfaV5vlM-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/w9-gfaV5vlM/full.txt`
...
- **dissent kept visible:** K-w9-gfaV5vlM-05, K-w9-gfaV5vlM-06, K-w9-gfaV5vlM-07, K-w9-gfaV5vlM-08
