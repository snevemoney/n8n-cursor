# Workflow — hours-deposit-then-they-ask-the-next-rung
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** hours-deposit-then-they-ask-the-next-rung
**Tape:** `Pi-m8R068r4` · caption-only · 6682 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-Pi-m8R068r4-01, K-Pi-m8R068r4-02, K-Pi-m8R068r4-03
...
- **Transcript:** `packets/Pi-m8R068r4/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `hours-deposit-then-they-ask-the-next-rung` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-Pi-m8R068r4-01, K-Pi-m8R068r4-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/Pi-m8R068r4/full.txt`
