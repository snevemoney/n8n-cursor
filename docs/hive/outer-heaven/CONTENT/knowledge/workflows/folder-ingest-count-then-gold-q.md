# Workflow — folder-ingest-count-then-gold-q
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** folder-ingest-count-then-gold-q
**Tape:** `Fu6vOfzFmcw` · caption-only · 397 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-Fu6vOfzFmcw-01, K-Fu6vOfzFmcw-02
...
- **Transcript:** `packets/Fu6vOfzFmcw/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `folder-ingest-count-then-gold-q` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/Fu6vOfzFmcw/full.txt`
