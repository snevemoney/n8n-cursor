# Workflow — where-x-determinism-deploy-chooser
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** where-x-determinism-deploy-chooser
**Tape:** `xJ5oz63mIec` · caption-only · 5337 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-xJ5oz63mIec-01, K-xJ5oz63mIec-02, K-xJ5oz63mIec-03, K-xJ5oz63mIec-04
- **dissent_ids:** K-xJ5oz63mIec-05, K-xJ5oz63mIec-06, K-xJ5oz63mIec-07, K-xJ5oz63mIec-08
...
- **Transcript:** `packets/xJ5oz63mIec/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `where-x-determinism-deploy-chooser` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-xJ5oz63mIec-01, K-xJ5oz63mIec-02
- **dissent_ids:** K-xJ5oz63mIec-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/xJ5oz63mIec/full.txt`
...
- **dissent kept visible:** K-xJ5oz63mIec-05, K-xJ5oz63mIec-06, K-xJ5oz63mIec-07, K-xJ5oz63mIec-08
