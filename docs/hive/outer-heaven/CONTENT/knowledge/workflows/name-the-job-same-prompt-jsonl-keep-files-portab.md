# Workflow — name-the-job-same-prompt-jsonl-keep-files-portab
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** name-the-job → same-prompt → JSONL → keep-files-portable
**Tape:** `RLjaUES9P8A` · caption-only · 7082 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-RLjaUES9P8A-01, K-RLjaUES9P8A-02, K-RLjaUES9P8A-03
...
- **Transcript:** `packets/RLjaUES9P8A/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `name-the-job-same-prompt-jsonl-keep-files-portab` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-RLjaUES9P8A-01, K-RLjaUES9P8A-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/RLjaUES9P8A/full.txt`
