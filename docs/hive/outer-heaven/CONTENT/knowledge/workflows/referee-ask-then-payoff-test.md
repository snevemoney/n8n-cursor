# Workflow — referee-ask-then-payoff-test
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** referee-ask-then-payoff-test
**Tape:** `CvA8-aScqio` · caption-only · 2914 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-CvA8-aScqio-01, K-CvA8-aScqio-02, K-CvA8-aScqio-03, K-CvA8-aScqio-04
- **dissent_ids:** K-CvA8-aScqio-05
...
- **Transcript:** `packets/CvA8-aScqio/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `referee-ask-then-payoff-test` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-CvA8-aScqio-01, K-CvA8-aScqio-02
- **dissent_ids:** K-CvA8-aScqio-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/CvA8-aScqio/full.txt`
...
- **dissent kept visible:** K-CvA8-aScqio-05
