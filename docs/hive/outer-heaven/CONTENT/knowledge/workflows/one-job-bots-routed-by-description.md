# Workflow — one-job-bots-routed-by-description
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** one-job-bots-routed-by-description
**Tape:** `PQBYZQqan2g` · caption-only · 5168 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-PQBYZQqan2g-01, K-PQBYZQqan2g-02, K-PQBYZQqan2g-03
...
- **Transcript:** `packets/PQBYZQqan2g/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `one-job-bots-routed-by-description` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-PQBYZQqan2g-01, K-PQBYZQqan2g-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/PQBYZQqan2g/full.txt`
