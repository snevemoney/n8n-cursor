# Workflow — dirty-input-gate-async-ticket-schema-extract
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** dirty-input-gate → async-ticket → schema-extract
**Tape:** `BO-jFbN4p8Y` · caption-only · 6445 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-BO-jFbN4p8Y-01, K-BO-jFbN4p8Y-02, K-BO-jFbN4p8Y-03, K-BO-jFbN4p8Y-04
- **dissent_ids:** K-BO-jFbN4p8Y-05, K-BO-jFbN4p8Y-06
...
- **Transcript:** `packets/BO-jFbN4p8Y/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `dirty-input-gate-async-ticket-schema-extract` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-BO-jFbN4p8Y-01, K-BO-jFbN4p8Y-02
- **dissent_ids:** K-BO-jFbN4p8Y-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/BO-jFbN4p8Y/full.txt`
...
- **dissent kept visible:** K-BO-jFbN4p8Y-05, K-BO-jFbN4p8Y-06
