# Workflow — interview-never-rules-wat
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** interview-never-rules-wat
**Tape:** `AO5aW01DKHo` · caption-only · 5774 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-AO5aW01DKHo-01, K-AO5aW01DKHo-02, K-AO5aW01DKHo-03, K-AO5aW01DKHo-04
- **dissent_ids:** K-AO5aW01DKHo-05, K-AO5aW01DKHo-06
...
- **Transcript:** `packets/AO5aW01DKHo/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `interview-never-rules-wat` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-AO5aW01DKHo-01, K-AO5aW01DKHo-02
- **dissent_ids:** K-AO5aW01DKHo-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/AO5aW01DKHo/full.txt`
...
- **dissent kept visible:** K-AO5aW01DKHo-05, K-AO5aW01DKHo-06
