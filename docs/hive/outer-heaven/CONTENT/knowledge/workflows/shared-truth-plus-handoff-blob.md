# Workflow — shared-truth-plus-handoff-blob
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** shared-truth-plus-handoff-blob
**Tape:** `kB9iMD0EjT8` · caption-only · 2202 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-kB9iMD0EjT8-01, K-kB9iMD0EjT8-02, K-kB9iMD0EjT8-03, K-kB9iMD0EjT8-04
- **dissent_ids:** K-kB9iMD0EjT8-05, K-kB9iMD0EjT8-06
...
- **Transcript:** `packets/kB9iMD0EjT8/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `shared-truth-plus-handoff-blob` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-kB9iMD0EjT8-01, K-kB9iMD0EjT8-02
- **dissent_ids:** K-kB9iMD0EjT8-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/kB9iMD0EjT8/full.txt`
...
- **dissent kept visible:** K-kB9iMD0EjT8-05, K-kB9iMD0EjT8-06
