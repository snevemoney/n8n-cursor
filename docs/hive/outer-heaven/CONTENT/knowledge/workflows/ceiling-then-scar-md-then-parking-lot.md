# Workflow — ceiling-then-scar-md-then-parking-lot
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** ceiling-then-scar-md-then-parking-lot
**Tape:** `ZRb7D6R64hM` · caption-only · 5527 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-ZRb7D6R64hM-01, K-ZRb7D6R64hM-02, K-ZRb7D6R64hM-03
...
- **Transcript:** `packets/ZRb7D6R64hM/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `ceiling-then-scar-md-then-parking-lot` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-ZRb7D6R64hM-01, K-ZRb7D6R64hM-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/ZRb7D6R64hM/full.txt`
