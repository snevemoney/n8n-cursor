# Workflow — official-sentence-vs-feed-then-three-scenarios
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** official-sentence-vs-feed-then-three-scenarios
**Tape:** `lkR6mvqQQlk` · caption-only · 2731 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-lkR6mvqQQlk-01, K-lkR6mvqQQlk-02, K-lkR6mvqQQlk-03, K-lkR6mvqQQlk-04
- **dissent_ids:** K-lkR6mvqQQlk-05, K-lkR6mvqQQlk-06, K-lkR6mvqQQlk-07, K-lkR6mvqQQlk-08
...
- **Transcript:** `packets/lkR6mvqQQlk/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `official-sentence-vs-feed-then-three-scenarios` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-lkR6mvqQQlk-01, K-lkR6mvqQQlk-02
- **dissent_ids:** K-lkR6mvqQQlk-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/lkR6mvqQQlk/full.txt`
...
- **dissent kept visible:** K-lkR6mvqQQlk-05, K-lkR6mvqQQlk-06, K-lkR6mvqQQlk-07, K-lkR6mvqQQlk-08
