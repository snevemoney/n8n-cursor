# Workflow — classify-question-then-pick-retrieval
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** classify-question-then-pick-retrieval
**Tape:** `ZwQ8rJhVCr4` · caption-only · 641 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-ZwQ8rJhVCr4-01, K-ZwQ8rJhVCr4-02
...
- **Transcript:** `packets/ZwQ8rJhVCr4/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `classify-question-then-pick-retrieval` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/ZwQ8rJhVCr4/full.txt`
