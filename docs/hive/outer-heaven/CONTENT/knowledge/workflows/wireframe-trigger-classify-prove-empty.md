# Workflow — wireframe-trigger-classify-prove-empty
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** wireframe-trigger-classify-prove-empty
**Tape:** `9mqsVK6Iqoc` · caption-only · 327 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-9mqsVK6Iqoc-01, K-9mqsVK6Iqoc-02
...
- **Transcript:** `packets/9mqsVK6Iqoc/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `wireframe-trigger-classify-prove-empty` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/9mqsVK6Iqoc/full.txt`
