# Workflow — five-gates-then-route-cheap
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** five-gates-then-route-cheap
**Tape:** `XTBWVVcF3Pk` · caption-only · 2472 words read
**Compiled:** 2026-08-14
...
- **Transcript:** `packets/XTBWVVcF3Pk/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `five-gates-then-route-cheap` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/XTBWVVcF3Pk/full.txt`
