# Workflow — split-research-watch-idle-approve-subs
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** split-research-watch-idle-approve-subs
**Tape:** `xsAOpqjebOo` · caption-only · 452 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-xsAOpqjebOo-01, K-xsAOpqjebOo-02, K-xsAOpqjebOo-03, K-xsAOpqjebOo-04
- **dissent_ids:** K-xsAOpqjebOo-05, K-xsAOpqjebOo-06, K-xsAOpqjebOo-07
...
- **Transcript:** `packets/xsAOpqjebOo/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `split-research-watch-idle-approve-subs` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-xsAOpqjebOo-01, K-xsAOpqjebOo-02
- **dissent_ids:** K-xsAOpqjebOo-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/xsAOpqjebOo/full.txt`
...
- **dissent kept visible:** K-xsAOpqjebOo-05, K-xsAOpqjebOo-06, K-xsAOpqjebOo-07
