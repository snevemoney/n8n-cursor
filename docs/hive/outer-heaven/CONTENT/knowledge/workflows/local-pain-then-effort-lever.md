# Workflow — local-pain-then-effort-lever
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** local-pain-then-effort-lever
**Tape:** `q5lg3npxjAc` · caption-only · 3267 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-q5lg3npxjAc-01, K-q5lg3npxjAc-02, K-q5lg3npxjAc-03, K-q5lg3npxjAc-04
- **dissent_ids:** K-q5lg3npxjAc-05, K-q5lg3npxjAc-06, K-q5lg3npxjAc-07, K-q5lg3npxjAc-08
...
- **Transcript:** `packets/q5lg3npxjAc/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `local-pain-then-effort-lever` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-q5lg3npxjAc-01, K-q5lg3npxjAc-02
- **dissent_ids:** K-q5lg3npxjAc-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/q5lg3npxjAc/full.txt`
...
- **dissent kept visible:** K-q5lg3npxjAc-05, K-q5lg3npxjAc-06, K-q5lg3npxjAc-07, K-q5lg3npxjAc-08
