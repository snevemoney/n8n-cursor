# Workflow — cli-before-mcp-for-token-io
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** cli-before-mcp-for-token-io
**Tape:** `YHk45NEpspE` · caption-only · 3697 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-YHk45NEpspE-01, K-YHk45NEpspE-02, K-YHk45NEpspE-03
...
- **Transcript:** `packets/YHk45NEpspE/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `cli-before-mcp-for-token-io` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-YHk45NEpspE-01, K-YHk45NEpspE-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/YHk45NEpspE/full.txt`
