# Workflow — read-who-until-when-then-dont-loop-by-default
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** read-who-until-when-then-dont-loop-by-default
**Tape:** `dYrrEKXtttk` · caption-only · 2023 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-dYrrEKXtttk-01, K-dYrrEKXtttk-02
...
- **Transcript:** `packets/dYrrEKXtttk/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `read-who-until-when-then-dont-loop-by-default` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/dYrrEKXtttk/full.txt`
