# Workflow — api-then-macro-then-vision
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** api-then-macro-then-vision
**Tape:** `CB5bG4mvnS0` · caption-only · 4330 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-CB5bG4mvnS0-01, K-CB5bG4mvnS0-02, K-CB5bG4mvnS0-03, K-CB5bG4mvnS0-04
- **dissent_ids:** K-CB5bG4mvnS0-05, K-CB5bG4mvnS0-06
...
- **Transcript:** `packets/CB5bG4mvnS0/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `api-then-macro-then-vision` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-CB5bG4mvnS0-01, K-CB5bG4mvnS0-02
- **dissent_ids:** K-CB5bG4mvnS0-05
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/CB5bG4mvnS0/full.txt`
...
- **dissent kept visible:** K-CB5bG4mvnS0-05, K-CB5bG4mvnS0-06
