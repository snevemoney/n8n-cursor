# Workflow — paste-pin-apply-or-dont-automate
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** paste-pin-apply-or-dont-automate
**Tape:** `HbsbqMQE-lI` · caption-only · 521 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-HbsbqMQE-lI-01, K-HbsbqMQE-lI-02
...
- **Transcript:** `packets/HbsbqMQE-lI/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `paste-pin-apply-or-dont-automate` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/HbsbqMQE-lI/full.txt`
