# Workflow — stay-in-ttl-or-handoff
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** stay-in-ttl-or-handoff
**Tape:** `6cEQEba0i2A` · caption-only · 2535 words read
**Compiled:** 2026-08-14
...
- **Transcript:** `packets/6cEQEba0i2A/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `stay-in-ttl-or-handoff` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/6cEQEba0i2A/full.txt`
