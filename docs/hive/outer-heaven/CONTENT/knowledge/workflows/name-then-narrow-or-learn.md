# Workflow — name-then-narrow-or-learn
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** name-then-narrow-or-learn
**Tape:** `NHFbAg2b54U` · caption-only · 3858 words read
**Compiled:** 2026-08-14
...
- **support_ids:** K-NHFbAg2b54U-01, K-NHFbAg2b54U-02, K-NHFbAg2b54U-03
...
- **Transcript:** `packets/NHFbAg2b54U/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `name-then-narrow-or-learn` → run `deep-video-learning`
- **Do:** Follow the skill card. Map on-tape vendors to Cursor skills + Grok Bot + `cursor-ide-browser`.
- **Hive skill:** `deep-video-learning`
- **pattern_ids:** none — hive skill
- **support_ids:** K-NHFbAg2b54U-01, K-NHFbAg2b54U-02
- **dissent_ids:** none — caption-only speech≠behavior stays on LEARNED
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/NHFbAg2b54U/full.txt`
