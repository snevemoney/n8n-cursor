# Workflow — enroll-then-gold-q-with-locator
Status: compiled
Protocol: workflow-compiler
**Provenance:** WORKFLOW → PATTERN → ATOMS → TRANSCRIPT
**Title:** enroll-then-gold-q-with-locator
**Tape:** `KVFfApQZhE4` · caption-only · 524 words read
**Compiled:** 2026-08-14
...
- **Transcript:** `packets/KVFfApQZhE4/full.txt` @ UNKNOWN

### 2. Run named skill on Cursor+Grok
- **IF:** IF the tape machine is this `enroll-then-gold-q-with-locator` → run `deep-video-learning`
...
## Audits
- **coverage:** pass — five tasks sourced to hive skill or LEARNED/atoms/`packets/KVFfApQZhE4/full.txt`
