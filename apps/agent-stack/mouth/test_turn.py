...
class MouthTurnTest(unittest.TestCase):
    ...
    def test_wit_sir_and_pro_route(self) -> None:
        ...
        self.assertEqual(MOD.classify("the whole shelf")["verb"], "pro")
        self.assertEqual(MOD.classify("all professional skills")["verb"], "pro")
        self.assertEqual(MOD.classify("all university skills")["verb"], "pro")
        self.assertEqual(MOD.classify("all school skills")["verb"], "pro")
