...
- Name: Self-Healing Demo Test >> Another broken selector to test pattern detection
- Location: /Users/evenslouis/dev/lightning-platform/web/tests/bots/broken-button.spec.ts:37:7

# Error details

```
Error: browserType.launch: Executable doesn't exist at /Users/evenslouis/Library/Caches/ms-playwright/webkit-2158/pw_run.sh
╔═════════════════════════════════════════════════════════════════════════╗
