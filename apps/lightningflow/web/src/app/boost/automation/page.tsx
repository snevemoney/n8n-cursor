...
export default function AutomationPage() {
  const { goTo } = useSmartRedirect({ context: 'automation' })
    ...
    <div className="px-6 py-8 max-w-6xl mx-auto">
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          ...
          <p className="text-gray-400">Advanced workflow automation</p>
        </div>
      </div>
      ...
      <Card className="border-gray-800 bg-gray-900/50">
        ...
        <CardContent>
          <p className="text-gray-300">
            This section will include auto-invoicing, payment routing, and notification automation.
          </p>
        </CardContent>
      </Card>
    </div>
