...
`;
    ...
    try {
      if (!this.openai) {
        return {
          message: `I'd be happy to help you learn about Lightning Network! However, AI services are not currently available. 
...
`;
    ...
    try {
      if (!this.openai) {
        return {
          message: 'I\'m here to help with your business needs. However, AI services are not currently available. Please try again later or contact support.'
        };
      }
