// Phase 1.2: Extract small talk handler from helpers/intentHandlers.ts
// Power of 10 Rule 4: Focused module for small talk intent handling
 ...
 */
export async function tryHandleSmallTalk(params: {
  userMessage: string;
  ...
  // Filter to only user/assistant messages for small talk context
  const conversationHistory = fullHistory.filter(
