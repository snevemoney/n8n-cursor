...
export function createResourceAttributes(config: TelemetryConfig): Record<string, string> {
  return {
    [ResourceAttributes.ServiceName]: config.service.name,
    [ResourceAttributes.ServiceVersion]: config.service.version,
    [ResourceAttributes.ServiceNamespace]: config.service.namespace,
    [ResourceAttributes.DeploymentEnvironment]: config.deployment.environment,
    [ResourceAttributes.DeploymentRegion]: config.deployment.region || '',
    [ResourceAttributes.DeploymentDatacenter]: config.deployment.datacenter || '',
    [ResourceAttributes.DeploymentCluster]: config.deployment.cluster || '',
    [ResourceAttributes.RuntimeName]: config.runtime.name,
    [ResourceAttributes.RuntimeVersion]: config.runtime.version,
    [ResourceAttributes.RuntimeArch]: config.runtime.arch || '',
    [ResourceAttributes.ContainerName]: config.container.name || '',
    [ResourceAttributes.ContainerImage]: config.container.image || '',
    [ResourceAttributes.ContainerTag]: config.container.tag || ''
  };
}
