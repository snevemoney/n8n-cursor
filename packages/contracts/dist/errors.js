...
exports.httpStatusCodes = exports.errorCategories = exports.errorCatalog = void 0;
exports.createErrorResponse = createErrorResponse;
exports.getErrorInfo = getErrorInfo;
exports.getHttpStatus = getHttpStatus;
exports.isRetryable = isRetryable;
exports.getErrorCategory = getErrorCategory;
exports.createExpressErrorResponse = createExpressErrorResponse;
exports.createNextResponse = createNextResponse;
...
function createErrorResponse(code, details, requestId) {
    const errorInfo = exports.errorCatalog[code];
    return {
        error: code,
...
function getHttpStatus(code) {
    return exports.errorCatalog[code].http;
}
function isRetryable(code) {
    return exports.errorCatalog[code].retryable;
}
function getErrorCategory(code) {
    return exports.errorCatalog[code].category;
}
// Error response helpers for different frameworks
function createExpressErrorResponse(code, details, requestId) {
    const errorInfo = exports.errorCatalog[code];
    return {
...
function createNextResponse(code, details, requestId) {
    const errorInfo = exports.errorCatalog[code];
    return new Response(JSON.stringify(createErrorResponse(code, details, requestId)), {
        status: errorInfo.http,
        headers: {
...
function isValidErrorCode(code) {
    return code in exports.errorCatalog;
}
