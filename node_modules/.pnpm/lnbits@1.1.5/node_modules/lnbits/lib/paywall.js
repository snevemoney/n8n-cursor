...
exports.LNBitsPaywallClass = void 0;
const axios_1 = require("axios");
class LNBitsPaywallClass {
    constructor(params) {
        this.adminKey = '';
        this.invoiceReadKey = '';
        this.endpoint = 'https://lnbits.com';
        this.getPaywalls = () => __awaiter(this, void 0, void 0, function* () {
        ...
        this.createPaywall = (params) => __awaiter(this, void 0, void 0, function* () {
            this.api.defaults.headers['X-Api-Key'] = this.invoiceReadKey;
            return yield this.api
        ...
        this.createInvoice = (params) => __awaiter(this, void 0, void 0, function* () {
            this.api.defaults.headers['X-Api-Key'] = this.invoiceReadKey;
            return yield this.api
        ...
        this.checkInvoice = (params) => __awaiter(this, void 0, void 0, function* () {
            this.api.defaults.headers['X-Api-Key'] = this.invoiceReadKey;
            return yield this.api
        ...
        this.deletePaywall = (params) => __awaiter(this, void 0, void 0, function* () {
...
exports.LNBitsPaywallClass = LNBitsPaywallClass;
