-- =============================================================================
-- DEMO DATABASE SETUP FOR DEPRECIATION RADAR
-- =============================================================================

-- Create demo database if it doesn't exist
CREATE DATABASE IF NOT EXISTS lightningflow_monitoring;

-- Connect to the demo database
\c lightningflow_monitoring;

-- Create demo tables and views for the depreciation radar
...
-- 4. Create a simple depreciation score view
CREATE OR REPLACE VIEW v_depreciation_score AS
SELECT 
    AVG(depreciation_score) as current_score,
