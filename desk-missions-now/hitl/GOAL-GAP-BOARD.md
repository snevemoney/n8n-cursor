...
| Gap | On disk | Daily move | Last OBSERVED | Stop |
|-----|---------|------------|----------------------------|------|
...
| **16 steal/caption leftovers** | Ledger `steal_gap` **16**. 1803 is a count, not a to-do. | Prefer steal_gap + packet + `full.txt` + ACTION TRACE **on this checkout**. Else TRIAGE. | **OBSERVED 2026-08-26:** no unused TRAIN-eligible pair on checkout. `2J3uX8iRNng` LEARNED+TRACE present; `full.txt` MISSING. | Do not flip `COVERAGE_LEDGER.json` |
...
| **Hold-outs Watchdog-first** | Watchdog wrote `watchdog/hold-outs/X80ljdCPM_U.md`. Forge attempt + GRADE now on disk. | Watchdog writes hold-outs before Forge. GRADE only in a sitting that did not write those hold-outs. | **OBSERVED 2026-08-26:** Researcher TRIAGE pick written. No new hold-outs. Do not start TRAIN-3 unless Evens names a real packet id. | Builder does not fill GRADE |
...
**Last OBSERVED (2026-08-26 · Researcher pick):** `desk-missions-now/researcher/NEXT-TRAIN-PICK.md` = **TRIAGE + coverage hole**. No unused `full.txt` + ACTION TRACE pair on this checkout. Retrieve **NONE**. Did not invent a slug. Did not write hold-outs. Did not GRADE. Next = Evens leftover (commit a real unused packet to `main`, or name an id). Yellow orphans = 8, continue.

**Last OBSERVED (2026-08-25 · Watchdog GRADE):** `desk-missions-now/watchdog/X80ljdCPM_U-GRADE.md` = **pass** vs hold-outs + ACTION TRACE. Leftovers named (skill `.md` missing on main · retrieve holes · caption UNKNOWN). Do not re-grade. Yellow orphans = 8, continue.
