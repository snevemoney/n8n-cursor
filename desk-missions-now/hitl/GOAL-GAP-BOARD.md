...
| **Hold-outs Watchdog-first** | TRAIN-1 leftover: Forge wrote the exam. This sitting: Watchdog wrote `watchdog/hold-outs/X80ljdCPM_U.md`. | Watchdog writes hold-outs before Forge. GRADE only in a later sitting. | **OBSERVED 2026-08-25:** Watchdog authored hidden exam for `X80ljdCPM_U`. No Forge attempt. No signal GRADE. Next Cloud TRAIN = Forge OBSERVED only. | Builder does not fill GRADE |
...
**Already closed (do not redo):** TRAIN-1 `kwSVtQ7dziU` GRADE PASS · process card `SIGNAL-TRAIN-LOOP.md` · color leftover GRADE PASS (4823 HTTP GOOD — not walkthrough) · walkthrough missing-path GRADE PASS.
...
**Last OBSERVED (2026-08-25 · Watchdog hold-outs):** [PR 48](https://github.com/snevemoney/n8n-cursor/pull/48) merged (`48982b9d1`). Hidden exam `desk-missions-now/watchdog/hold-outs/X80ljdCPM_U.md` Watchdog-authored. No Forge. No signal GRADE. Next sitting = Forge OBSERVED only. Yellow orphans = 8, continue.
