...
| Build site/page/game | `slice-build` | Bible → plan → one system |
...
| Any steal / business type | `steal-usecases` + `.cursor/skills/steal-sheet` | One master `STEAL_SHEET.md` (Watch Later **and** X bookmarks) + `business-types.json` — pick icp_id then router. Doctrine: `DEEP_SUMMARIES.md` |
