...
| Mentor me while I build / what do I put in the system | `saylor-mentor-pass` | End of sitting: LANE + 1–3 skills + PUT-IN-SYSTEM + LEVERAGE + NEXT. Emit `os/reports/mentor.md`. Grok Consultant on demand. |
...
| Am I set up / world thinks I am a master | `saylor-mentor-pass` | Score `saylor-setup-score.py`. ARMED-TO-WORK ≠ catalog-complete. Master = one visitor-visible proof (`inbound-from-demonstrated-build`). |
