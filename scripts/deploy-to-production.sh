...
echo "🚀 Deploying Local UI to lightningflow.online"
echo "=============================================="
...
EOF
    ...
    echo "   https://lightningflow.online"
    echo ""
