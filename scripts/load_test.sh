...
npx autocannon -c 10 -d 20 https://lightningflow.online/healthz

echo ""

# Test 2: Main site
echo "2. Testing main site (20 connections, 30 seconds)..."
npx autocannon -c 20 -d 30 https://lightningflow.online/

echo ""

# Test 3: API endpoint
echo "3. Testing API endpoint (15 connections, 25 seconds)..."
npx autocannon -c 15 -d 25 https://lightningflow.online/api/system-check
...
npx autocannon -c 50 -d 30 https://lightningflow.online/
