...
echo "🔄 STARTING SERVER UPDATE AND N8N DEPLOYMENT"
echo "============================================="
...
# Enable ESM Apps for additional security updates
...
print_status "Step 6: Checking for failed automatic updates..."
...
print_status "Step 7: Installing security packages..."
sudo apt install -y fail2ban ufw auditd unattended-upgrades

print_status "Step 8: Configuring automatic security updates..."
sudo dpkg-reconfigure --priority=low unattended-upgrades

# Step 3: Docker and n8n Setup
print_status "Step 9: Checking Docker status..."
if ! command -v docker &> /dev/null; then
    print_error "Docker not installed. Installing Docker..."
...
print_status "Step 12: Creating production Docker Compose..."
...
print_status "Step 13: Creating Caddy configuration..."
...
print_status "Step 14: Stopping existing services..."
sudo docker compose -f /opt/lightningflow/docker-compose.prod.yml down 2>/dev/null || true

print_status "Step 15: Starting production services..."
cd /opt/lightningflow
sudo docker compose -f docker-compose.prod.yml up -d

print_status "Step 16: Waiting for services to start..."
sleep 30

# Step 6: Verification
print_status "Step 17: Checking service status..."
echo "Docker containers:"
sudo docker ps --format "table {{.Names}}\t{{.Status}}\t{{.Ports}}"

echo ""
print_status "Step 18: Testing n8n health endpoint..."
...
echo ""
print_status "Step 19: Testing Caddy configuration..."
...
print_status "Step 20: Running security scan..."
